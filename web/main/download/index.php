...
?>
<form name="loginform" id="loginform" action="<?php echo $_SERVER['../../crtm/download/PHP_SELF'];?>" method="post">
...
<form name="newuserform" id="newuserform" action="<?php echo $_SERVER['../../crtm/download/PHP_SELF'];?>" method="post">
  <div class="title">
    <h2>New Users:</h2>
    <p style="margin: 0px; padding-bottom: 3px; ">Please register to gain access
      ...
      see our <a href="../../crtm/download/notes.php?note=privacy">privacy policy</a>.</p>
  </div>
    ...
    <tr>
      ...
      <td colspan="3" style="padding-bottom: 0px;"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <p style="margin-top: 0px;">You will be emailed a confirmation email
          when you submit this form that will include instructions on <a href="../../crtm/download/notes.php?note=list">how
