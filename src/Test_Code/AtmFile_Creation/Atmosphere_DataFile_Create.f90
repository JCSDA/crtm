!
! Atmosphere_Create_DataFile
!
! Module containing routines to create a
...
PROGRAM Atmosphere_Create_DataFile
  ...
  ! Parameters
  CHARACTER(*), PARAMETER :: PROGRAM_NAME = 'Atmosphere_DataFile_Create'
  CHARACTER(*), PARAMETER :: Atmosphere_Filename = 'Cloud.bin'
  ...
  Profile_Loop: DO m = 1, N_Profiles*n_Surface_Types
    ...
    Longitude_Loop: DO j = 1, N_Lats
      Latitude_Loop: DO i = 1, N_Lons
        ...
        Atmosphere_Expanded(m)%Climatology==TROPICAL .AND. Land_Flag .AND. &
  ...
  Error_Status = CRTM_Write_Surface_Binary( 'Surface.bin'     , & ! Filename
...
END PROGRAM Atmosphere_Create_DataFile
