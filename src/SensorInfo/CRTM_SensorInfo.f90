...
MODULE CRTM_SensorInfo
  ...
  INTEGER, PUBLIC, PARAMETER :: INVALID_WMO_SENSORID = 2047
  ...
  INTEGER, PUBLIC, PARAMETER :: WMO_ABI     = INVALID_WMO_SENSORID
  INTEGER, PUBLIC, PARAMETER :: WMO_WINDSAT = INVALID_WMO_SENSORID
  INTEGER, PUBLIC, PARAMETER :: WMO_ATMS    = INVALID_WMO_SENSORID

  ! WMO SATELLITE codes from COMMON CODE TABLE C-5
  INTEGER, PUBLIC, PARAMETER :: INVALID_WMO_SATELLITEID = 1023
  ...
  INTEGER, PUBLIC, PARAMETER :: WMO_GOESR      = INVALID_WMO_SATELLITEID
  INTEGER, PUBLIC, PARAMETER :: WMO_CORIOLIS   = INVALID_WMO_SATELLITEID
  INTEGER, PUBLIC, PARAMETER :: WMO_NPOESSC1   = INVALID_WMO_SATELLITEID

CONTAINS

  FUNCTION CRTM_Get_SensorAttributes( SensorID       , &  ! Input
                                      nChannels      , &  ! Optional output
                                      nFOVs          , &  ! Optional output       
                                      Detector       , &  ! Optional output    
                                      WMO_SensorID   , &  ! Optional output
                                      WMO_SatelliteID, &  ! Optional output
                                      SensorName     , &  ! Optional output
                                      SatelliteName  , &  ! Optional output
                                      Message_Log    ) &  ! Error messaging 
                                    RESULT( Error_Status )
    ! Arguments
    CHARACTER(*),           INTENT(IN)  :: SensorID
    INTEGER,      OPTIONAL, INTENT(OUT) :: nChannels
    INTEGER,      OPTIONAL, INTENT(OUT) :: nFOVs
    INTEGER,      OPTIONAL, INTENT(OUT) :: Detector
    INTEGER,      OPTIONAL, INTENT(OUT) :: WMO_SensorID   
    INTEGER,      OPTIONAL, INTENT(OUT) :: WMO_SatelliteID
    ...
    INTEGER       :: local_WMO_SensorID   
    INTEGER       :: local_WMO_SatelliteID
    ...
    local_nFOVs           =  0
    local_Detector        = -1
    local_WMO_SensorID    = INVALID_WMO_SENSORID
    local_WMO_SatelliteID = INVALID_WMO_SATELLITEID
    ...
    SELECT CASE (TRIM(ADJUSTL(SensorID)))
      CASE('hirs2_n05')
        local_nChannels       = 19
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 605
        local_WMO_SatelliteID = 708
      ...
      CASE('hirs3_n15')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 606
        local_WMO_SatelliteID = 206
      ...
      CASE('hirs4_n18')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 607
        local_WMO_SatelliteID = 209
      ...
      CASE('vas_g04')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 630
        local_WMO_SatelliteID = 734
      ...
      CASE('sndr_g08')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 626
        local_WMO_SatelliteID = 252
      ...
      CASE('abi_gr')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = -1
        local_WMO_SatelliteID = -1
      ...
      CASE('imgr_mt1r')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 294
        local_WMO_SatelliteID = 171
        local_SensorName      = 'IMAGER'
      ...
      CASE('ssmi_f13')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 905
        local_WMO_SatelliteID = 246
      ...
      CASE('ssmis_f16')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 908
        local_WMO_SatelliteID = 249
      ...
      CASE('modis_terra')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 389
        local_WMO_SatelliteID = 783
      ...
      CASE('vissrDetA_gms5')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 489
        local_WMO_SatelliteID = 152
      ...
      CASE('mviriNOM_m03')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 205
        local_WMO_SatelliteID = 50
      ...
      CASE('seviri_msg01')
        ...
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 207
        local_WMO_SatelliteID = 71
        local_SensorName      = 'SEVIRI'
        local_SatelliteName   = 'METEOSAT-SG1'
      CASE('windsat_coriolis')
        local_nChannels       = 16
        local_nFOVs           = -1
        local_Detector        = -1
        local_WMO_SensorID    = 2047
        local_WMO_SatelliteID = 283
      ...
      CASE DEFAULT
        ...
        CALL Display_Message( ROUTINE_NAME, &
                              'No entry for SensorID '//TRIM(ADJUSTL(SensorID)), &
                              Error_Status, &
    ...
    IF ( PRESENT(WMO_SensorID   ) ) WMO_SensorID   =local_WMO_SensorID          
    IF ( PRESENT(WMO_SatelliteID) ) WMO_SatelliteID=local_WMO_SatelliteID       
