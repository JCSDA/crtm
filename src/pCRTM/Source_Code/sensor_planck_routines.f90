...
!
! PURPOSE:
!       Module containing the sensor Planck function routines used in the
!       prototype CRTM (pCRTM).
!
! CATEGORY:
!       pCRTM
!
...
!
! PROCEDURE:
!       First the effective temperature is calculated from the inverse Planck
!       function,
!
!                        pc2
!         T_eff = ------------------
...
!-------------------------------------------------------------------------------
!
! $Id: sensor_planck_routines.f90,v 2.1 2004/12/22 17:43:33 paulv Exp $
!
