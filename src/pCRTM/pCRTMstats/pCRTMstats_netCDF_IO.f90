...
!M+
! NAME:
!       pCRTM : pCRTMstats_netCDF_IO
!
! PURPOSE:
!       Module containing routines to read and write pCRTMstats netCDF 
!       format files.
!       
! CATEGORY:
!       pCRTM : pCRTMstats
...
!
!       pCRTMstats_Define:     Module defining the pCRTMstats data structure and
...
!
! CONTAINS:
!       Inquire_pCRTMstats_netCDF:  Function to inquire a netCDF format 
!                                   pCRTMstats file to obtain information
!                                   about the data dimensions and attributes.
!
!       Write_pCRTMstats_netCDF:    Function to write pCRTMstats data to a
!                                   netCDF format pCRTMstats file.
!
!       Read_pCRTMstats_netCDF:     Function to read pCRTMstats data from a
!                                   netCDF format pCRTMstats file.
!
! INCLUDE FILES:
!       None.
...
MODULE pCRTMstats_netCDF_IO
  ...
  USE netcdf
  USE netCDF_Utility,  Open_pCRTMstats_netCDF =>  Open_netCDF, &
                      Close_pCRTMstats_netCDF => Close_netCDF
  ...
  PRIVATE
  PUBLIC :: Inquire_pCRTMstats_netCDF
  PUBLIC :: Write_pCRTMstats_netCDF
  PUBLIC :: Read_pCRTMstats_netCDF
  ...
  CHARACTER( * ), PRIVATE, PARAMETER :: MODULE_RCS_ID = &
    '$Id: pCRTMstats_netCDF_IO.f90,v 1.6 2006/05/02 14:58:35 dgroff Exp $'
...
!
! NAME:
!       Write_pCRTMstats_GAtts
!
! PURPOSE:
!       Function to write the global attributes to a netCDF pCRTMstats
!       data file.
!
! CATEGORY:
!       pCRTM : pCRTMstats
...
!
! CALLING SEQUENCE:
!       Error_Status = Write_pCRTMstats_GAtts( NC_Filename,                             &  ! Input
!                                              NC_fileID,                               &  ! Input
...
!                            netCDF pCRTMstats format data file to create.
!                            UNITS:      N/A
!                            TYPE:       CHARACTER(*)
!                            DIMENSION:  Scalar
...
!                            of the netCDF pCRTMstats file. Should contain
...
!                            attribute field of the netCDF pCRTMstats file.
...
!                            global attribute field of the netCDF pCRTMstats
!                            file.
!                            UNITS:      N/A
!                            TYPE:       CHARACTER(*)
!                            DIMENSION:  Scalar
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Write_pCRTMstats_GAtts( NC_Filename,        &  ! Input
                                   NC_fileID,          &  ! Input
    ...
    CHARACTER( * ), PARAMETER :: ROUTINE_NAME = 'Write_pCRTMstats_GAtts'
  ...
  END FUNCTION Write_pCRTMstats_GAtts
...
!
! NAME:
!       Read_pCRTMstats_GAtts
!
! PURPOSE:
!       Function to read the global attributes from a netCDF pCRTMstats
!       data file.
!
! CATEGORY:
!       pCRTM : pCRTMstats
...
!
! CALLING SEQUENCE:
!       Error_Status = Read_pCRTMstats_GAtts( NC_Filename,                             &  ! Input
!                                             NC_fileID,                               &  ! Input
...
! INPUT ARGUMENTS:
!       NC_Filename:      Character string specifying the name of the
!                         netCDF pCRTMstats format data file to read from.
!                         UNITS:      N/A
!                         TYPE:       CHARACTER(*)
!                         DIMENSION:  Scalar
!                         ATTRIBUTES: INTENT( IN )
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Read_pCRTMstats_GAtts( NC_Filename,        &  ! Input
                                  NC_fileID,          &  ! Input
    ...
    CHARACTER( * ), PARAMETER :: ROUTINE_NAME = 'Read_pCRTMstats_GAtts'
  ...
  END FUNCTION Read_pCRTMstats_GAtts
...
!
! NAME:
!       Create_pCRTMstats_netCDF
!
! PURPOSE:
!       Function to create a netCDF pCRTMstats data file for writing.
!
! CATEGORY:
!       pCRTM : pCRTMstats
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Create_pCRTMstats_netCDF( NC_Filename,                             &  ! Input
!                                                n_Channels,                              &  ! Input
!                                                n_Angles,                                &  ! Input
!                                                n_Profiles,                              &  ! Input
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Create_pCRTMstats_netCDF( NC_Filename,        &  ! Input
                                     n_Channels,         &  ! Input
                                     n_Angles,           &  ! Input
                                     n_Profiles,         &  ! Input
                                     n_Molecule_Sets,    &  ! Input
    ...
    CHARACTER( * ), PARAMETER :: ROUTINE_NAME = 'Create_pCRTMstats_netCDF'
  ...
  END FUNCTION Create_pCRTMstats_netCDF
...
!S+
! NAME:
!       Inquire_pCRTMstats_netCDF
!
! PURPOSE:
!       Function to inquire a netCDF pCRTMstats format file to obtain
...
!
! CALLING SEQUENCE:
!       Error_Status = Inquire_pCRTMstats_netCDF( NC_Filename,                             &  ! Input
...
! INPUT ARGUMENTS:
!       NC_Filename:        Character string specifying the name of the
!                           pCRTMstats netCDF format data file to inquire.
!                           UNITS:      N/A
!                           TYPE:       CHARACTER(*)
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: INTENT( IN )
...
!
! CALLS:
!       Open_pCRTMstats_netCDF:  Function to open a pCRTMstats netCDF
!                                format data file.
...
!                                SOURCE: NETCDF_UTILITY module
!
!       Close_pCRTMstats_netCDF: Function to close a pCRTMstats netCDF
!                                format data file.
!                                SOURCE: NETCDF_UTILITY module
!
!       Display_Message:         Subroutine to output messages
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Inquire_pCRTMstats_netCDF( NC_Filename,        &  ! Input
    ...
    CHARACTER( * ), PARAMETER :: ROUTINE_NAME = 'Inquire_pCRTMstats_netCDF'
    ...
    Error_Status = Open_pCRTMstats_netCDF( TRIM( NC_Filename ), &
                                           NC_FileID, &
                                           Mode = 'READ' )

    IF ( Error_Status /= SUCCESS ) THEN
      CALL Display_Message( ROUTINE_NAME, &
                            'Error opening netCDF pCRTMstats data file '//&
                            TRIM( NC_Filename ), &
                            Error_Status, &
                            Message_Log = Message_Log )
      RETURN
    ...
    Error_Status = Read_pCRTMstats_GAtts( TRIM( NC_Filename ), &
                                          NC_fileID, &
                                          LBL_Profile_ID_Tag = LBL_Profile_ID_Tag, &
                                          REG_Profile_ID_Tag = REG_Profile_ID_Tag, &
                                          Title              = Title, &
    ...
    Close_Status = Close_pCRTMstats_netCDF( NC_FileID )

    IF ( Close_Status /= SUCCESS ) THEN
      Error_Status = WARNING
      CALL Display_Message( ROUTINE_NAME, &
                            'Error closing netCDF pCRTMstats data file '// &
                            TRIM( NC_Filename ), &
                            Error_Status, &
                            Message_Log = Message_Log )
    END IF

  END FUNCTION Inquire_pCRTMstats_netCDF
...
!S+
! NAME:
!       Write_pCRTMstats_netCDF
!
! PURPOSE:
!       Function to write an pCRTMstats data structure to a netCDF format
!       pCRTMstats file.
!
! CATEGORY:
!       pCRTM : pCRTMstats
...
!
! CALLING SEQUENCE:
!       Error_Status = Write_pCRTMstats_netCDF( NC_Filename,                   &  ! Input
!                                               pCRTMstats,                    &  ! Input
!                                               Title         = Title,         &  ! Optional input
!                                               History       = History,       &  ! Optional input
!                                               Sensor_Name   = Sensor_Name,   &  ! Optional input
...
!                        format pCRTMstats data file to write data into.
!                        UNITS:      N/A
!                        TYPE:       CHARACTER(*)
!                        DIMENSION:  Scalar
!                        ATTRIBUTES: INTENT( IN )
!
!       pCRTMstats:      Structure containing the data to write to file.
!                        UNITS:      N/A
...
!
! CALLS:
!       Create_pCRTMstats_netCDF:   Function to create a new netCDF format
!                                   pCRTMstats file.
!
!       Close_pCRTMstats_netCDF:    Function to close a pCRTMstats netCDF
!                                   format file.
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Write_pCRTMstats_netCDF( NC_Filename,   &  ! Input
                                    pCRTMstats,    &  ! Input
                                    Title,         &  ! Optional input
                                    History,       &  ! Optional input
                                    Sensor_Name,   &  ! Optional input
    ...
    CHARACTER( * ), PARAMETER :: ROUTINE_NAME = 'Write_pCRTMstats_netCDF'
    ...
    Error_Status = Create_pCRTMstats_netCDF( TRIM( NC_Filename ),      &  ! Input
                                             pCRTMstats%n_Channels,      &  ! Input
                                             pCRTMstats%n_Angles,        &  ! Input
                                             pCRTMstats%n_Profiles,      &  ! Input
                                             pCRTMstats%n_Molecule_Sets, &  ! Input
                                             NC_FileID,                &  ! Output 
                                             LBL_Profile_ID_Tag = TRIM( pCRTMstats%LBL_Profile_ID_Tag ), &  ! Optional input
                                             REG_Profile_ID_Tag = TRIM( pCRTMstats%REG_Profile_ID_Tag ), &  ! Optional input
                                             Title              = Title,         &  ! Optional input
                                             History            = History,       &  ! Optional input
                                             Sensor_Name        = Sensor_Name,   &  ! Optional input
                                             Platform_Name      = Platform_Name, &  ! Optional input
    ...
    IF ( Error_Status /= SUCCESS ) THEN
      CALL display_message( ROUTINE_NAME, &
                            'Error creating output netCDF pCRTMstats file '//&
                            TRIM( NC_Filename ), &
                            Error_Status, &
                            Message_Log = Message_Log )
      NF90_Status = NF90_CLOSE( NC_fileID )
    ...
    Error_Status = Close_pCRTMstats_netCDF( NC_FileID )
    ...
    IF ( Noisy ) THEN
      CALL Information_pCRTMstats( pCRTMstats, Message )
      CALL Display_Message( ROUTINE_NAME, &
  ...
  END FUNCTION Write_pCRTMstats_netCDF
...
!S+
! NAME:
!       Read_pCRTMstats_netCDF
!
! PURPOSE:
!       Function to read a netCDF format pCRTMstats file.
!
! CATEGORY:
!       pCRTM : pCRTMstats
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Read_pCRTMstats_netCDF( NC_Filename,                   &  ! Input
!                                              pCRTMstats,                      &  ! Output
!                                              Quiet         = Quiet,         &  ! Optional input
!                                              Title         = Title,         &  ! Optional output
!                                              History       = History,       &  ! Optional output
...
! INPUT ARGUMENTS:
!       NC_Filename:     Character string specifying the name of the
!                        netCDF format pCRTMstats data file to read.
!                        UNITS:      N/A
!                        TYPE:       CHARACTER(*)
!                        DIMENSION:  Scalar
!                        ATTRIBUTES: INTENT( IN )
...
!
! OUTPUT ARGUMENTS:
!       pCRTMstats:      Structure containing the data read from file.
!                        UNITS:      N/A
!                        TYPE:       pCRTMstats_type
!                        DIMENSION:  Scalar
...
!------------------------------------------------------------------------------
  ...
  FUNCTION Read_pCRTMstats_netCDF( NC_Filename,   &  ! Input
                                   pCRTMstats,    &  ! Output
                                   Quiet,         &  ! Optional input
                                   Title,         &  ! Optional output
                                   History,       &  ! Optional output
    ...
    CHARACTER( * ), PARAMETER :: ROUTINE_NAME = 'Read_pCRTMstats_netCDF'
    ...
    !#--------------------------------------------------------------------------#
    !#   -- GET THE DIMENSION VALUES AND ALLOCATE THE pCRTMstats STRUCTURE --   #
    !#--------------------------------------------------------------------------#
    ...
    Error_Status = Inquire_pCRTMstats_netCDF( TRIM( NC_Filename ), &
    ...
    IF ( Error_Status /= SUCCESS ) THEN
      CALL Display_Message( ROUTINE_NAME, &
                            'Error obtaining pCRTMstats dimensions from '//&
                            TRIM( NC_Filename ), &
                            Error_Status, &
                            Message_Log = Message_Log )
      RETURN
    ...
    IF ( Error_Status /= SUCCESS ) THEN
      CALL Display_Message( ROUTINE_NAME,    &
                            'Error occurred allocating pCRTMstats structure.', &
                            Error_Status,    &
                            Message_Log = Message_Log )
      RETURN
    END IF
    ...
    Error_Status = Read_pCRTMstats_GAtts( TRIM( NC_Filename ), &
                                          NC_FileID, &
                                          LBL_Profile_ID_Tag = pCRTMstats%LBL_Profile_ID_Tag, &
                                          REG_Profile_ID_Tag = pCRTMstats%REG_Profile_ID_Tag, &
                                          Title         = Title, &
                                          History       = History, &
                                          Sensor_Name   = Sensor_Name, &
                                          Platform_Name = Platform_Name, &
    ...
    IF ( Error_Status /= SUCCESS ) THEN
      CALL Display_Message( ROUTINE_NAME, &
                            'Error obtaining pCRTMstats global attributes from '//&
                            TRIM( NC_Filename ), &
                            Error_Status, &
                            Message_Log = Message_Log )
      RETURN
    ...
    CALL Count_pCRTMstats_Sensors( pCRTMstats, Use_WMO_ID = SET )
  ...
  END FUNCTION Read_pCRTMstats_netCDF

END MODULE pCRTMstats_netCDF_IO
...
! $State: Exp $
!
! $Log: pCRTMstats_netCDF_IO.f90,v $
...
! - Altered the I/O functions to relfect the changes in the pCRTMstats structure
