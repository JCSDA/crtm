...
MODULE MW_SensorData_Define
  ...
  '$Id: MW_SensorData_Define.f90,v 1.25 2006/05/02 16:58:02 dgroff Exp $'
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER :: POINT5 = 0.5_fp_kind
  ...
  TYPE, PUBLIC :: MW_SensorData_type
    ...
    ! -- Sensor data
    REAL( fp_kind ), POINTER, DIMENSION( : )       :: Central_Frequency => NULL()  ! L
    INTEGER( Long ), POINTER, DIMENSION( : )       :: Polarization      => NULL()  ! L
    INTEGER( Long ), POINTER, DIMENSION( : )       :: n_Sidebands       => NULL()  ! L
    REAL( fp_kind ), POINTER, DIMENSION( :, :, : ) :: IF_Band           => NULL()  ! 2 x 2 x L

    ! -- MW channel frequency and response grid
    REAL( fp_kind ), POINTER, DIMENSION( : )    :: Delta_Frequency => NULL()  ! L
    REAL( fp_kind ), POINTER, DIMENSION( :, : ) :: Frequency       => NULL()  ! Lm x L
    REAL( fp_kind ), POINTER, DIMENSION( :, : ) :: Response        => NULL()  ! Lm x L
  ...
  INTEGER, PRIVATE, PARAMETER, &
    ...
    (/ 205, 206, 207, 208, 209, 210, 211, 212, 214, &  ! NOAA-05 to -14 MSU (no NOAA-13)
       ...
       320, 420, &                                     ! MetOp-A (was MetOp-2) AMSU-A and MHS (Proposed)
       321, 421, &                                     ! MetOp-B (was MetOp-1) AMSU-A and MHS (Proposed)
       322, 422 /)                                     ! MetOp-C (was MetOp-3) AMSU-A and MHS (Proposed)
  ...
  INTEGER, PRIVATE, PARAMETER, &
    ...
    (/ 708, 706, 707, 200, 201, 202, 203, 204, 205, &  ! NOAA-05 to -14 MSU (no NOAA-13)
       ...
       210, 210, &                                     ! NOAA-N' AMSU-A and MHS (GUESS. NOT LISTED IN C-5)
         4,   4, &                                     ! MetOp-A (was MetOp-2) AMSU-A and MHS
         3,   3, &                                     ! MetOp-B (was MetOp-1) AMSU-A and MHS
         5,   5 /)                                     ! MetOp-C (was MetOp-3) AMSU-A and MHS
  ...
  INTEGER, PRIVATE, PARAMETER, &
    ...
    (/ 623, 623, 623, 623, 623, 623, 623, 623, 623, &  ! NOAA-05 to -14 MSU (no NOAA-13)
       ...
       570, 203, &                                     ! MetOp-A (was MetOp-2) AMSU-A and MHS
       570, 203, &                                     ! MetOp-B (was MetOp-1) AMSU-A and MHS
       570, 203 /)                                     ! MetOp-C (was MetOp-3) AMSU-A and MHS
  ...
  CHARACTER( * ), PRIVATE, PARAMETER, &
    ...
    (/ 'MSU    ', 'MSU    ', 'MSU    ', 'MSU    ', 'MSU    ', &
       ...
       'AMSU-A ', 'MHS    ', &                                   ! MetOp-A (was MetOp-2) AMSU-A and MHS
       'AMSU-A ', 'MHS    ', &                                   ! MetOp-B (was MetOp-1) AMSU-A and MHS
       'AMSU-A ', 'MHS    ' /)                                   ! MetOp-C (was MetOp-3) AMSU-A and MHS
  ...
  CHARACTER( * ), PRIVATE, PARAMETER, &
    ...
    (/ 'TIROS-N  ', 'NOAA-06  ', 'NOAA-07  ', 'NOAA-08  ', 'NOAA-09  ', &
       ...
       'MetOp-A  ', 'MetOp-A  ', &                                        ! MetOp-A (was MetOp-2) AMSU-A and MHS
       'MetOp-B  ', 'MetOp-B  ', &                                        ! MetOp-B (was MetOp-1) AMSU-A and MHS
       'MetOp-C  ', 'MetOp-C  ' /)                                        ! MetOp-C (was MetOp-3) AMSU-A and MHS
  ...
  INTEGER, PRIVATE, PARAMETER, &
    ...
    (/ N_MSU_CHANNELS, N_MSU_CHANNELS, N_MSU_CHANNELS, N_MSU_CHANNELS, & ! NOAA-05 to -08 MSU
       ...
       N_AMSUA_CHANNELS, N_MHS_CHANNELS, &                               ! MetOp-A (was MetOp-2) AMSU-A and MHS
       N_AMSUA_CHANNELS, N_MHS_CHANNELS, &                               ! MetOp-B (was MetOp-1) AMSU-A and MHS
       N_AMSUA_CHANNELS, N_MHS_CHANNELS /)                               ! MetOp-C (was MetOp-3) AMSU-A and MHS
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 50.35_fp_kind, 53.79_fp_kind, 55.02_fp_kind, 58.01_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.01_fp_kind, 0.1_fp_kind, ZERO, ZERO, &    ! MSU ch1
                0.01_fp_kind, 0.1_fp_kind, ZERO, ZERO, &    ! MSU ch2
                0.01_fp_kind, 0.1_fp_kind, ZERO, ZERO, &    ! MSU ch3
                0.01_fp_kind, 0.1_fp_kind, ZERO, ZERO /), & ! MSU ch4
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800370_fp_kind, 31.400420_fp_kind, 50.299910_fp_kind, &
       52.799390_fp_kind, 53.595410_fp_kind, 54.399530_fp_kind, &
       54.940640_fp_kind, 55.498700_fp_kind, 57.290329_fp_kind, &
       57.290329_fp_kind, 57.290329_fp_kind, 57.290329_fp_kind, &
       57.290329_fp_kind, 57.290329_fp_kind, 88.997000_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00850_fp_kind,  0.13551_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1
                0.00897_fp_kind,  0.08957_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2
                0.00895_fp_kind,  0.08952_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3
                0.00890_fp_kind,  0.19916_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4
                0.03110_fp_kind,  0.19930_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5
                0.00894_fp_kind,  0.19921_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6
                0.00891_fp_kind,  0.19919_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7
                0.00891_fp_kind,  0.16408_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8
                0.00891_fp_kind,  0.16412_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9
                0.17916_fp_kind,  0.25574_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10
                0.257435_fp_kind, 0.292545_fp_kind, 0.353570_fp_kind, 0.387850_fp_kind, &     ! AMSU-A1 ch11
                0.292745_fp_kind, 0.308035_fp_kind, 0.337050_fp_kind, 0.352130_fp_kind, &     ! AMSU-A1 ch12
                0.308315_fp_kind, 0.316245_fp_kind, 0.328320_fp_kind, 0.336240_fp_kind, &     ! AMSU-A1 ch13
                0.316200_fp_kind, 0.319120_fp_kind, 0.325370_fp_kind, 0.328310_fp_kind, &     ! AMSU-A1 ch14
                0.49871_fp_kind,  1.49820_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/  88.992_fp_kind, 149.992_fp_kind, 183.312_fp_kind, &
       183.312_fp_kind, 183.312_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.399_fp_kind, 1.405_fp_kind, ZERO, ZERO, &    ! AMSU-B ch16
                0.398_fp_kind, 1.401_fp_kind, ZERO, ZERO, &    ! AMSU-B ch17
                0.762_fp_kind, 1.243_fp_kind, ZERO, ZERO, &    ! AMSU-B ch18
                2.512_fp_kind, 3.491_fp_kind, ZERO, ZERO, &    ! AMSU-B ch19
                6.002_fp_kind, 7.873_fp_kind, ZERO, ZERO /), & ! AMSU-B ch20
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800110_fp_kind, 31.400580_fp_kind, 50.299700_fp_kind, &
       52.800740_fp_kind, 53.595470_fp_kind, 54.399780_fp_kind, &
       54.940770_fp_kind, 55.499540_fp_kind, 57.290324_fp_kind, &
       57.290324_fp_kind, 57.290324_fp_kind, 57.290324_fp_kind, &
       57.290324_fp_kind, 57.290324_fp_kind, 88.999800_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00858_fp_kind,  0.13403_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1
                0.00887_fp_kind,  0.08957_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2
                0.00898_fp_kind,  0.08956_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3
                0.00891_fp_kind,  0.19916_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4
                0.03094_fp_kind,  0.19920_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5
                0.00892_fp_kind,  0.19922_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6
                0.00888_fp_kind,  0.19919_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7
                0.00894_fp_kind,  0.16402_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8
                0.00887_fp_kind,  0.16417_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9
                0.17876_fp_kind,  0.25545_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10
                0.257140_fp_kind, 0.291780_fp_kind, 0.353095_fp_kind, 0.387585_fp_kind, &     ! AMSU-A1 ch11
                0.292715_fp_kind, 0.308025_fp_kind, 0.336865_fp_kind, 0.351875_fp_kind, &     ! AMSU-A1 ch12
                0.308195_fp_kind, 0.316165_fp_kind, 0.328350_fp_kind, 0.336250_fp_kind, &     ! AMSU-A1 ch13
                0.316325_fp_kind, 0.319255_fp_kind, 0.325340_fp_kind, 0.328240_fp_kind, &     ! AMSU-A1 ch14
                0.49943_fp_kind,  1.49645_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/  89.0056_fp_kind, 150.0080_fp_kind, 183.2990_fp_kind, &
       183.2990_fp_kind, 183.2990_fp_kind /)

  ! -- AMSU-B I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_AMSUB_CHANNELS ) :: AMSUB_N16_IF_BAND = &
    RESHAPE( (/ 0.399_fp_kind, 1.405_fp_kind, ZERO, ZERO, &    ! AMSU-B ch16
                0.397_fp_kind, 1.397_fp_kind, ZERO, ZERO, &    ! AMSU-B ch17
                0.751_fp_kind, 1.245_fp_kind, ZERO, ZERO, &    ! AMSU-B ch18
                2.507_fp_kind, 3.485_fp_kind, ZERO, ZERO, &    ! AMSU-B ch19
                6.011_fp_kind, 7.989_fp_kind, ZERO, ZERO /), & ! AMSU-B ch20
             (/ 2, MAX_N_SIDEBANDS, N_AMSUB_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 19.35_fp_kind, 19.35_fp_kind, &
       22.235_fp_kind, &
       37.0_fp_kind,  37.0_fp_kind, &
       85.5_fp_kind,  85.5_fp_kind /)

  ! -- SSM/I I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_SSMI_CHANNELS ) :: SSMI_IF_BAND = &
    RESHAPE( (/ 0.010_fp_kind, 0.250_fp_kind, ZERO, ZERO, &    ! SSM/I ch1
                0.010_fp_kind, 0.250_fp_kind, ZERO, ZERO, &    ! SSM/I ch2
                0.010_fp_kind, 0.250_fp_kind, ZERO, ZERO, &    ! SSM/I ch3
                0.100_fp_kind, 1.000_fp_kind, ZERO, ZERO, &    ! SSM/I ch4
                0.100_fp_kind, 1.000_fp_kind, ZERO, ZERO, &    ! SSM/I ch5
                0.100_fp_kind, 1.500_fp_kind, ZERO, ZERO, &    ! SSM/I ch6
                0.100_fp_kind, 1.500_fp_kind, ZERO, ZERO /), & ! SSM/I ch7
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 50.5_fp_kind, 53.2_fp_kind, 54.35_fp_kind, &
       54.9_fp_kind, 58.4_fp_kind, &
       58.825_fp_kind, &
       59.4_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.000_fp_kind, 0.2000_fp_kind, ZERO, ZERO, &    ! SSM/T-1 ch1
                0.000_fp_kind, 0.2000_fp_kind, ZERO, ZERO, &    ! SSM/T-1 ch2
                0.000_fp_kind, 0.2000_fp_kind, ZERO, ZERO, &    ! SSM/T-1 ch3
                0.000_fp_kind, 0.2000_fp_kind, ZERO, ZERO, &    ! SSM/T-1 ch4
                0.000_fp_kind, 0.0575_fp_kind, ZERO, ZERO, &    ! SSM/T-1 ch5
                0.000_fp_kind, 0.2000_fp_kind, ZERO, ZERO, &    ! SSM/T-1 ch6
                0.000_fp_kind, 0.1250_fp_kind, ZERO, ZERO /), & ! SSM/T-1 ch7
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 183.31000_fp_kind, 183.31000_fp_kind, 183.31000_fp_kind, &
        91.66500_fp_kind, 150.00000_fp_kind /)

  ! -- SSM-T/2 I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_SSMT2_CHANNELS ) :: SSMT2_IF_BAND = &
    RESHAPE( (/ 2.500_fp_kind, 3.500_fp_kind, ZERO, ZERO, &    ! SSM-T/2 ch1
                0.750_fp_kind, 1.250_fp_kind, ZERO, ZERO, &    ! SSM-T/2 ch2
                6.250_fp_kind, 7.750_fp_kind, ZERO, ZERO, &    ! SSM-T/2 ch3
                0.500_fp_kind, 2.000_fp_kind, ZERO, ZERO, &    ! SSM-T/2 ch4
                0.500_fp_kind, 2.000_fp_kind, ZERO, ZERO /), & ! SSM-T/2 ch5
...
!!  REAL( fp_kind ), PRIVATE, PARAMETER, &
!!                   DIMENSION( 2, MAX_N_SIDEBANDS, N_SSMIS_CHANNELS ) :: SSMIS_F16_IF_BAND = &
!!    RESHAPE( (/ 0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch1
!!                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch2
!!                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch3
!!                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch4
!!                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch5
!!                0.000000_fp_kind,  0.175000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch6
!!                0.000000_fp_kind,  0.125000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch7
!!                0.500000_fp_kind,  2.000000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch8
!!                5.850000_fp_kind,  7.350000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch9
!!                2.500000_fp_kind,  3.500000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch10
!!                0.750000_fp_kind,  1.250000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch11
!!                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch12
!!                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch13
!!                0.000000_fp_kind,  0.225000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch14
!!                0.000000_fp_kind,  0.750000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch15
!!                0.000000_fp_kind,  0.750000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch16
!!                0.150000_fp_kind,  1.650000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch17
!!                0.150000_fp_kind,  1.650000_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch18
!!                0.284521_fp_kind,  0.286021_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch19
!!                0.357142_fp_kind,  0.358642_fp_kind,  ZERO,             ZERO,            &     ! SSMIS ch20
!!                0.355142_fp_kind,  0.356642_fp_kind,  0.359142_fp_kind,  0.360642_fp_kind, &     ! SSMIS ch21
!!                0.350892_fp_kind,  0.353892_fp_kind,  0.361892_fp_kind,  0.364892_fp_kind, &     ! SSMIS ch22
!!                0.337892_fp_kind,  0.345892_fp_kind,  0.369892_fp_kind,  0.377892_fp_kind, &     ! SSMIS ch23
!!                0.292892_fp_kind,  0.322892_fp_kind,  0.392892_fp_kind,  0.422892_fp_kind /), &  ! SSMIS ch24
!!             (/ 2, MAX_N_SIDEBANDS, N_SSMIS_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800000_fp_kind, 31.400000_fp_kind, 50.300000_fp_kind, &
       52.800000_fp_kind, 53.596000_fp_kind, 54.400000_fp_kind, &
       54.940000_fp_kind, 55.500000_fp_kind, 57.290344_fp_kind, &
       57.290344_fp_kind, 57.290344_fp_kind, 57.290344_fp_kind, &
       57.290344_fp_kind, 57.290344_fp_kind, 89.000000_fp_kind /)

  ! -- AMSU-A I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS ) :: AMSUA_AQUA_IF_BAND = &
    RESHAPE( (/ 0.01000_fp_kind,  0.13500_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1
                0.01000_fp_kind,  0.09000_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2
                0.01000_fp_kind,  0.09000_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3
                0.01000_fp_kind,  0.20000_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4
                0.03000_fp_kind,  0.20000_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5
                0.01000_fp_kind,  0.20000_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6
                0.01000_fp_kind,  0.20000_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7
                0.01000_fp_kind,  0.16500_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8
                0.01000_fp_kind,  0.16500_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9
                0.17800_fp_kind,  0.25600_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10
                0.256200_fp_kind, 0.292200_fp_kind, 0.352200_fp_kind, 0.388200_fp_kind, &     ! AMSU-A1 ch11
                0.292200_fp_kind, 0.308200_fp_kind, 0.336200_fp_kind, 0.352200_fp_kind, &     ! AMSU-A1 ch12
                0.308200_fp_kind, 0.316200_fp_kind, 0.328200_fp_kind, 0.336200_fp_kind, &     ! AMSU-A1 ch13
                0.316200_fp_kind, 0.319200_fp_kind, 0.325200_fp_kind, 0.328200_fp_kind, &     ! AMSU-A1 ch14
                0.50000_fp_kind,  1.50000_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 150.000_fp_kind, 183.310_fp_kind, 183.310_fp_kind, 183.310_fp_kind /)

  ! -- HSB I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_HSB_CHANNELS ) :: HSB_AQUA_IF_BAND = &
    RESHAPE( (/ 0.400_fp_kind, 1.400_fp_kind, ZERO, ZERO, &    ! HSB ch1 == AMSU-B ch2
                0.750_fp_kind, 1.250_fp_kind, ZERO, ZERO, &    ! HSB ch2 == AMSU-B ch3
                2.500_fp_kind, 3.500_fp_kind, ZERO, ZERO, &    ! HSB ch3 == AMSU-B ch4
                6.000_fp_kind, 8.000_fp_kind, ZERO, ZERO /), & ! HSB ch4 == AMSU-B ch5
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 6.925_fp_kind,  6.925_fp_kind, 10.650_fp_kind, 10.650_fp_kind, &
      18.700_fp_kind, 18.700_fp_kind, 23.800_fp_kind, 23.800_fp_kind, &
      36.500_fp_kind, 36.500_fp_kind, 89.000_fp_kind, 89.000_fp_kind /)

  ! -- AMSR-E I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_AMSRE_CHANNELS ) :: AMSRE_AQUA_IF_BAND = &
    RESHAPE( (/ 0.000_fp_kind, 0.175_fp_kind, ZERO, ZERO, &     ! 6.925GHz vertical pol.
                0.000_fp_kind, 0.175_fp_kind, ZERO, ZERO, &     ! 6.925GHz horizontal pol.
                0.000_fp_kind, 0.050_fp_kind, ZERO, ZERO, &     ! 10.65GHz vertical pol.
                0.000_fp_kind, 0.050_fp_kind, ZERO, ZERO, &     ! 10.65GHz horizontal pol.
                0.000_fp_kind, 0.100_fp_kind, ZERO, ZERO, &     ! 18.7GHz vertical pol.
                0.000_fp_kind, 0.100_fp_kind, ZERO, ZERO, &     ! 18.7GHz horizontal pol.
                0.000_fp_kind, 0.200_fp_kind, ZERO, ZERO, &     ! 23.8GHz vertical pol.
                0.000_fp_kind, 0.200_fp_kind, ZERO, ZERO, &     ! 23.8GHz horizontal pol.
                0.000_fp_kind, 0.500_fp_kind, ZERO, ZERO, &     ! 36.5GHz vertical pol.
                0.000_fp_kind, 0.500_fp_kind, ZERO, ZERO, &     ! 36.5GHz horizontal pol.
                0.000_fp_kind, 1.500_fp_kind, ZERO, ZERO, &     ! 89.0GHz vertical pol.
                0.000_fp_kind, 1.500_fp_kind, ZERO, ZERO /), &  ! 89.0GHz horizontal pol.
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800837_fp_kind, 31.399518_fp_kind, 50.299742_fp_kind, &
       52.800072_fp_kind, 53.595969_fp_kind, 54.399819_fp_kind, &
       54.940337_fp_kind, 55.500255_fp_kind, 57.290335_fp_kind, &
       57.290335_fp_kind, 57.290335_fp_kind, 57.290335_fp_kind, &
       57.290335_fp_kind, 57.290335_fp_kind, 89.009713_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00872_fp_kind,  0.13423_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1
                0.00877_fp_kind,  0.08912_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2
                0.00890_fp_kind,  0.08900_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3
                0.00912_fp_kind,  0.19916_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4
                0.03138_fp_kind,  0.19886_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5
                0.00915_fp_kind,  0.19933_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6
                0.00910_fp_kind,  0.19919_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7
                0.00914_fp_kind,  0.16402_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8
                0.00911_fp_kind,  0.16415_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9
                0.17901_fp_kind,  0.25534_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10
                0.256806_fp_kind, 0.291663_fp_kind, 0.352663_fp_kind, 0.388032_fp_kind, &     ! AMSU-A1 ch11
                0.292552_fp_kind, 0.307980_fp_kind, 0.336329_fp_kind, 0.351829_fp_kind, &     ! AMSU-A1 ch12
                0.308288_fp_kind, 0.316136_fp_kind, 0.328226_fp_kind, 0.336086_fp_kind, &     ! AMSU-A1 ch13
                0.316321_fp_kind, 0.319253_fp_kind, 0.325312_fp_kind, 0.328254_fp_kind, &     ! AMSU-A1 ch14
                0.49208_fp_kind,  1.48898_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/  89.000_fp_kind, 157.000_fp_kind, 183.311_fp_kind, &
       183.311_fp_kind, 190.311_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.111_fp_kind, 1.207_fp_kind, ZERO, ZERO, &    ! MHS ch16
                0.111_fp_kind, 1.207_fp_kind, ZERO, ZERO, &    ! MHS ch17
                0.752_fp_kind, 1.210_fp_kind, ZERO, ZERO, &    ! MHS ch18
                2.524_fp_kind, 3.434_fp_kind, ZERO, ZERO, &    ! MHS ch19
                0.113_fp_kind, 1.079_fp_kind, ZERO, ZERO /), & ! MHS ch20
             (/ 2, MAX_N_SIDEBANDS, N_MHS_CHANNELS /) )

! These are the LO B values
!    RESHAPE( (/ 0.111_fp_kind, 1.207_fp_kind, ZERO, ZERO, &    ! MHS ch16
!                0.113_fp_kind, 1.209_fp_kind, ZERO, ZERO, &    ! MHS ch17
!                0.750_fp_kind, 1.210_fp_kind, ZERO, ZERO, &    ! MHS ch18
!                2.526_fp_kind, 3.430_fp_kind, ZERO, ZERO, &    ! MHS ch19
!                0.113_fp_kind, 1.079_fp_kind, ZERO, ZERO /), & ! MHS ch20
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 6.8_fp_kind,  6.8_fp_kind, &
      10.7_fp_kind, 10.7_fp_kind, 10.7_fp_kind, 10.7_fp_kind, &
      18.7_fp_kind, 18.7_fp_kind, 18.7_fp_kind, 18.7_fp_kind, &
      23.8_fp_kind, 23.8_fp_kind, &
      37.0_fp_kind, 37.0_fp_kind, 37.0_fp_kind, 37.0_fp_kind /)

  ! -- WindSat I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_WINDSAT_CHANNELS ) :: WINDSAT_CORIOLIS_IF_BAND = &
    RESHAPE( (/ 0.000_fp_kind, 0.0625_fp_kind, ZERO, ZERO, &    !  6.8GHz vertical pol.
                0.000_fp_kind, 0.0625_fp_kind, ZERO, ZERO, &    !  6.8GHz horizontal pol.
                0.000_fp_kind, 0.150_fp_kind,  ZERO, ZERO, &    ! 10.7GHz R(h) + R(v)
                0.000_fp_kind, 0.150_fp_kind,  ZERO, ZERO, &    ! 10.7GHz R(h) - R(v)    
                0.000_fp_kind, 0.150_fp_kind,  ZERO, ZERO, &    ! 10.7GHz R(+45) - R(-45)
                0.000_fp_kind, 0.150_fp_kind,  ZERO, ZERO, &    ! 10.7GHz R(rc) - R(lc)  
                0.000_fp_kind, 0.375_fp_kind,  ZERO, ZERO, &    ! 18.7GHz R(h) + R(v)
                0.000_fp_kind, 0.375_fp_kind,  ZERO, ZERO, &    ! 18.7GHz R(h) - R(v)    
                0.000_fp_kind, 0.375_fp_kind,  ZERO, ZERO, &    ! 18.7GHz R(+45) - R(-45)
                0.000_fp_kind, 0.375_fp_kind,  ZERO, ZERO, &    ! 18.7GHz R(rc) - R(lc)  
                0.000_fp_kind, 0.250_fp_kind,  ZERO, ZERO, &    ! 23.8GHz vertical pol.
                0.000_fp_kind, 0.250_fp_kind,  ZERO, ZERO, &    ! 23.8GHz horizontal pol.
                0.000_fp_kind, 1.000_fp_kind,  ZERO, ZERO, &    ! 37.0GHz R(h) + R(v)
                0.000_fp_kind, 1.000_fp_kind,  ZERO, ZERO, &    ! 37.0GHz R(h) - R(v)    
                0.000_fp_kind, 1.000_fp_kind,  ZERO, ZERO, &    ! 37.0GHz R(+45) - R(-45)
                0.000_fp_kind, 1.000_fp_kind,  ZERO, ZERO /), & ! 37.0GHz R(rc) - R(lc)  
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800000_fp_kind,  31.400000_fp_kind,  50.300000_fp_kind,  51.760000_fp_kind, &
       52.800000_fp_kind,  53.596000_fp_kind,  54.400000_fp_kind,  54.940000_fp_kind, &
       55.500000_fp_kind,  57.290344_fp_kind,  57.290344_fp_kind,  57.290344_fp_kind, &
       57.290344_fp_kind,  57.290344_fp_kind,  57.290344_fp_kind,  88.200000_fp_kind, &
      165.500000_fp_kind, 183.310000_fp_kind, 183.310000_fp_kind, 183.310000_fp_kind, &
      183.310000_fp_kind, 183.310000_fp_kind /)

  ! -- ATMS I/F band limits in GHz.
  REAL( fp_kind ), PRIVATE, PARAMETER, &
                   DIMENSION( 2, MAX_N_SIDEBANDS, N_ATMS_CHANNELS ) :: ATMS_C1_IF_BAND = &
    RESHAPE( (/ 0.000000_fp_kind,  0.135000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch1
                0.000000_fp_kind,  0.090000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch2
                0.000000_fp_kind,  0.090000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch3
                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch4
                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch5
                0.030000_fp_kind,  0.200000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch6
                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch7
                0.000000_fp_kind,  0.200000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch8
                0.000000_fp_kind,  0.165000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch9
                0.000000_fp_kind,  0.165000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch10
                0.178000_fp_kind,  0.256000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch11
                0.256200_fp_kind,  0.292200_fp_kind,  0.352200_fp_kind,  0.388200_fp_kind, &      ! ATMS ch12
                0.292200_fp_kind,  0.308200_fp_kind,  0.336200_fp_kind,  0.352200_fp_kind, &      ! ATMS ch13
                0.308200_fp_kind,  0.316200_fp_kind,  0.328200_fp_kind,  0.336200_fp_kind, &      ! ATMS ch14
                0.316200_fp_kind,  0.319200_fp_kind,  0.325200_fp_kind,  0.328200_fp_kind, &      ! ATMS ch15
                0.000000_fp_kind,  1.000000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch16
                0.000000_fp_kind,  1.500000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch17
                6.000000_fp_kind,  8.000000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch18
                3.500000_fp_kind,  5.500000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch19
                2.500000_fp_kind,  3.500000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch20
                1.300000_fp_kind,  2.300000_fp_kind,  ZERO,              ZERO,             &      ! ATMS ch21
                0.750000_fp_kind,  1.250000_fp_kind,  ZERO,              ZERO             /), &   ! ATMS ch22
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800904_fp_kind, 31.400728_fp_kind, 50.300271_fp_kind, &
       52.800655_fp_kind, 53.596130_fp_kind, 54.400131_fp_kind, &
       54.939489_fp_kind, 55.498680_fp_kind, 57.290329_fp_kind, &
       57.290329_fp_kind, 57.290329_fp_kind, 57.290329_fp_kind, &
       57.290329_fp_kind, 57.290329_fp_kind, 89.010000_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00867_fp_kind,  0.13416_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1 (pg.107)
                0.00893_fp_kind,  0.08892_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2 (pg.118)
                0.00884_fp_kind,  0.08896_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3 (pg.211)
                0.00904_fp_kind,  0.19924_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4 (pg.222)
                0.03140_fp_kind,  0.19926_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5 (pg.233)
                0.00914_fp_kind,  0.19911_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6 (pg.244)
                0.00913_fp_kind,  0.19928_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7 (pg.255)
                0.00919_fp_kind,  0.16425_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8 (pg.266)
                0.00916_fp_kind,  0.16422_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9 (pg.277)
                0.17934_fp_kind,  0.25532_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10 (pg.288)
                0.256937_fp_kind, 0.291835_fp_kind, 0.352592_fp_kind, 0.387883_fp_kind, &     ! AMSU-A1 ch11 (pp.302[LO],303[HI])
                0.292551_fp_kind, 0.307988_fp_kind, 0.336236_fp_kind, 0.351764_fp_kind, &     ! AMSU-A1 ch12 (pp.315[LO],316[HI])
                0.308247_fp_kind, 0.316070_fp_kind, 0.328234_fp_kind, 0.336887_fp_kind, &     ! AMSU-A1 ch13 (pp.328[LO],329[HI])
                0.316274_fp_kind, 0.319223_fp_kind, 0.325256_fp_kind, 0.328212_fp_kind, &     ! AMSU-A1 ch14 (pp.341[LO],342[HI])
                0.49157_fp_kind,  1.48733_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15 (pg.349)
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.118_fp_kind, 1.217_fp_kind, ZERO, ZERO, &    ! MHS ch16
                0.111_fp_kind, 1.211_fp_kind, ZERO, ZERO, &    ! MHS ch17
                0.745_fp_kind, 1.219_fp_kind, ZERO, ZERO, &    ! MHS ch18
                2.520_fp_kind, 3.367_fp_kind, ZERO, ZERO, &    ! MHS ch19
                0.112_fp_kind, 1.071_fp_kind, ZERO, ZERO /), & ! MHS ch20
             (/ 2, MAX_N_SIDEBANDS, N_MHS_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.799744_fp_kind, 31.402100_fp_kind, 50.299733_fp_kind, &
       52.800575_fp_kind, 53.596741_fp_kind, 54.399710_fp_kind, &
       54.939924_fp_kind, 55.500450_fp_kind, 57.290313_fp_kind, &
       57.290313_fp_kind, 57.290313_fp_kind, 57.290313_fp_kind, &
       57.290313_fp_kind, 57.290313_fp_kind, 88.003000_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00861_fp_kind,  0.13415_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1 (pg.103)
                0.00875_fp_kind,  0.08915_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2 (pg.114)
                0.00879_fp_kind,  0.08909_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3 (pg.205)
                0.00907_fp_kind,  0.19936_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4 (pg.205)
                0.03130_fp_kind,  0.19900_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5 (pg.205)
                0.00907_fp_kind,  0.19938_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6 (pg.205)
                0.00913_fp_kind,  0.19932_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7 (pg.205)
                0.00914_fp_kind,  0.16419_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8 (pg.205)
                0.00915_fp_kind,  0.16414_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9 (pg.205)
                0.17914_fp_kind,  0.25527_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10 (pg.205)
                0.256977_fp_kind, 0.291873_fp_kind, 0.352628_fp_kind, 0.387892_fp_kind, &     ! AMSU-A1 ch11 (pp.206)
                0.292565_fp_kind, 0.307998_fp_kind, 0.336332_fp_kind, 0.351781_fp_kind, &     ! AMSU-A1 ch12 (pp.206)
                0.308312_fp_kind, 0.316124_fp_kind, 0.328339_fp_kind, 0.336215_fp_kind, &     ! AMSU-A1 ch13 (pp.206)
                0.316278_fp_kind, 0.319208_fp_kind, 0.325201_fp_kind, 0.328140_fp_kind, &     ! AMSU-A1 ch14 (pp.206)
                0.49129_fp_kind,  1.48691_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15 (pg.205)
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.112_fp_kind, 1.206_fp_kind, ZERO, ZERO, &    ! MHS ch16
                0.114_fp_kind, 1.211_fp_kind, ZERO, ZERO, &    ! MHS ch17
                0.750_fp_kind, 1.218_fp_kind, ZERO, ZERO, &    ! MHS ch18
                2.500_fp_kind, 3.330_fp_kind, ZERO, ZERO, &    ! MHS ch19
                0.111_fp_kind, 1.065_fp_kind, ZERO, ZERO /), & ! MHS ch20
             (/ 2, MAX_N_SIDEBANDS, N_MHS_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800335_fp_kind, 31.401473_fp_kind, 50.300069_fp_kind, &
       52.799890_fp_kind, 53.596155_fp_kind, 54.400633_fp_kind, &
       54.940002_fp_kind, 55.499802_fp_kind, 57.290327_fp_kind, &
       57.290327_fp_kind, 57.290327_fp_kind, 57.290327_fp_kind, &
       57.290327_fp_kind, 57.290327_fp_kind, 88.997000_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00852_fp_kind,  0.13416_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1 (pg.103)
                0.00916_fp_kind,  0.08938_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2 (pg.114)
                0.00885_fp_kind,  0.08921_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3 (pg.208)
                0.00905_fp_kind,  0.19903_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4 (pg.208)
                0.03134_fp_kind,  0.19909_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5 (pg.208)
                0.00910_fp_kind,  0.19930_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6 (pg.208)
                0.00915_fp_kind,  0.19923_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7 (pg.208)
                0.00906_fp_kind,  0.16419_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8 (pg.208)
                0.00913_fp_kind,  0.16402_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9 (pg.208)
                0.17921_fp_kind,  0.25508_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10 (pg.208)
                0.257043_fp_kind, 0.291937_fp_kind, 0.352609_fp_kind, 0.387988_fp_kind, &     ! AMSU-A1 ch11 (pp.302[LO],303[HI])
                0.292628_fp_kind, 0.308060_fp_kind, 0.336465_fp_kind, 0.351940_fp_kind, &     ! AMSU-A1 ch12 (pp.315[LO],316[HI])
                0.308343_fp_kind, 0.316152_fp_kind, 0.328359_fp_kind, 0.335223_fp_kind, &     ! AMSU-A1 ch13 (pp.328[LO],329[HI])
                0.316276_fp_kind, 0.319209_fp_kind, 0.325346_fp_kind, 0.328300_fp_kind, &     ! AMSU-A1 ch14 (pp.341[LO],342[HI])
                0.48978_fp_kind,  1.48805_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15 (pg.208)
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.113_fp_kind, 1.202_fp_kind, ZERO, ZERO, &    ! MHS ch16
                0.112_fp_kind, 1.205_fp_kind, ZERO, ZERO, &    ! MHS ch17
                0.748_fp_kind, 1.218_fp_kind, ZERO, ZERO, &    ! MHS ch18
                2.517_fp_kind, 3.362_fp_kind, ZERO, ZERO, &    ! MHS ch19
                0.112_fp_kind, 1.077_fp_kind, ZERO, ZERO /), & ! MHS ch20
             (/ 2, MAX_N_SIDEBANDS, N_MHS_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    (/ 23.800558_fp_kind, 31.402120_fp_kind, 50.300397_fp_kind, &
       52.799710_fp_kind, 53.596297_fp_kind, 54.399751_fp_kind, &
       54.940644_fp_kind, 55.499839_fp_kind, 57.290335_fp_kind, &
       57.290335_fp_kind, 57.290335_fp_kind, 57.290335_fp_kind, &
       57.290335_fp_kind, 57.290335_fp_kind, 89.000800_fp_kind /)
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.00860_fp_kind,  0.13412_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch1 (pg.103)
                0.00906_fp_kind,  0.08922_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A2 ch2 (pg.114)
                0.00884_fp_kind,  0.08928_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch3 (pg.195)
                0.00920_fp_kind,  0.19904_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch4 (pg.105)
                0.03134_fp_kind,  0.19905_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch5 (pg.195)
                0.00914_fp_kind,  0.19919_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch6 (pg.195)
                0.00917_fp_kind,  0.19926_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch7 (pg.195)
                0.00907_fp_kind,  0.16406_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch8 (pg.195)
                0.00911_fp_kind,  0.16415_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch9 (pg.195)
                0.17887_fp_kind,  0.25511_fp_kind,  ZERO,             ZERO,             &     ! AMSU-A1 ch10 (pg.195)
                0.257070_fp_kind, 0.291921_fp_kind, 0.352406_fp_kind, 0.387740_fp_kind, &     ! AMSU-A1 ch11 (pp.196)
                0.292527_fp_kind, 0.307953_fp_kind, 0.336374_fp_kind, 0.351850_fp_kind, &     ! AMSU-A1 ch12 (pp.196)
                0.308370_fp_kind, 0.316193_fp_kind, 0.328303_fp_kind, 0.336182_fp_kind, &     ! AMSU-A1 ch13 (pp.196)
                0.316245_fp_kind, 0.319180_fp_kind, 0.325187_fp_kind, 0.328350_fp_kind, &     ! AMSU-A1 ch14 (pp.196)
                0.49298_fp_kind,  1.48667_fp_kind,  ZERO,             ZERO              /), & ! AMSU-A1 ch15 (pg.195)
             (/ 2, MAX_N_SIDEBANDS, N_AMSUA_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, &
    ...
    RESHAPE( (/ 0.115_fp_kind, 1.209_fp_kind, ZERO, ZERO, &    ! MHS ch16
                0.111_fp_kind, 1.218_fp_kind, ZERO, ZERO, &    ! MHS ch17
                0.743_fp_kind, 1.215_fp_kind, ZERO, ZERO, &    ! MHS ch18
                2.485_fp_kind, 3.358_fp_kind, ZERO, ZERO, &    ! MHS ch19
                0.114_fp_kind, 1.078_fp_kind, ZERO, ZERO /), & ! MHS ch20
             (/ 2, MAX_N_SIDEBANDS, N_MHS_CHANNELS /) )
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_MSU_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_AMSUA_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_AMSUB_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_SSMI_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_SSMT1_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_SSMT2_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_SSMIS_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_HSB_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_AMSRE_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_MHS_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_WINDSAT_CHANNELS ) :: &
  ...
  REAL( fp_kind ), PRIVATE, PARAMETER, DIMENSION( N_ATMS_CHANNELS ) :: &
...
!                 paul.vandelst@ssec.wisc.edu
  ...
  FUNCTION Allocate_MW_SensorData( n_Channels,    &  ! Input
    ...
    MW_SensorData%Central_Frequency = REAL( INVALID, fp_kind )
    MW_SensorData%Polarization      = INVALID_POLARIZATION
    MW_SensorData%n_Sidebands       = INVALID
    MW_SensorData%IF_Band           = REAL( INVALID, fp_kind )
    MW_SensorData%Delta_Frequency   = REAL( INVALID, fp_kind )
    MW_SensorData%Frequency         = REAL( INVALID, fp_kind )
    MW_SensorData%Response          = REAL( INVALID, fp_kind )
  ...
  FUNCTION Load_MW_SensorData( MW_SensorData,    &  ! Output
    ...
    Channel_Response_Loop: DO l = 1, MW_SensorData%n_Channels
      ...
      IF ( MW_SensorData%n_Sidebands( l ) == 1 ) THEN
        MW_SensorData%Delta_Frequency(l) = df / REAL( N_HALFPOINTS - 1, fp_kind )
      ELSE
        MW_SensorData%Delta_Frequency(l) = df / REAL( N_HALFPOINTS - 2, fp_kind )
      END IF
      ...
      DO ln = 1, MW_SensorData%n_Sidebands(l)
        ...
        DO i = 1, n_Points( ln )
          ...
          f = f1 + ( REAL( i-1, fp_kind ) * MW_SensorData%Delta_Frequency(l) )
...
!                  paul.vandelst@ssec.wisc.edu
  ...
  SUBROUTINE Print_MW_SensorData( MW_SensorData ) ! Input
    ...
    INTEGER :: iL1, iL2
    INTEGER :: iU1, iU2
    REAL( fp_kind ), DIMENSION( 1:N_HALFBANDS*2 ) :: Frequency
