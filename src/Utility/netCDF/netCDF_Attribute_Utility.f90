...
!
!       NF90_INQUIRE_ATTRIBUTE: Function to inquire an attribute.
!                               SOURCE: netCDF module and library.
!
!       NF90_GET_ATT:           Function to get an attribute value.
!                               SOURCE: netCDF module and library.
!
...
!                               SOURCE: netCDF module and library.
!
!       NF90_PUT_ATT:           Function to write an attribute value.
!                               SOURCE: netCDF module and library.
!
!       Display_Message:        Subroutine to output messages
!                               SOURCE: Message_Handler module
