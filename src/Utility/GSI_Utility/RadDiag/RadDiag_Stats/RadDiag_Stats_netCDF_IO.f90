...
!------------------------------------------------------------------------------
  ...
  RESULT ( err_stat )
    ...
    IF ( NF90_Status /= NF90_NOERR ) THEN
      ...
      CALL Write_Cleanup(); RETURN
    END IF
    NF90_Status = NF90_PUT_VAR( FileId,VarID,RadDiag_Stats%FOV )
    IF ( NF90_Status /= NF90_NOERR ) THEN
    ...
    END IF
    ! ...scan_Data variable 
    NF90_Status = NF90_INQ_VARID( FileId,SCAN_DATA_VARNAME,VarId )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error inquiring '//TRIM(Filename)//' for '//SCAN_DATA_VARNAME//&
            ' variable ID - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Write_Cleanup(); RETURN
    END IF
    NF90_Status = NF90_PUT_VAR( FileId,VarID,RadDiag_Stats%scan_Data )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error writing '//SCAN_DATA_VARNAME//' to '//TRIM(Filename)//&
            ' - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Write_Cleanup(); RETURN
    END IF
    ...
    IF ( NF90_Status /= NF90_NOERR ) THEN
      ...
      CALL Write_Cleanup(); RETURN
    END IF
    NF90_Status = NF90_PUT_VAR( FileId,VarID,RadDiag_Stats%scan_nSamples )
    IF ( NF90_Status /= NF90_NOERR ) THEN
    ...
    END IF
    ! ...time_Data variable 
    NF90_Status = NF90_INQ_VARID( FileId,TIME_DATA_VARNAME,VarId )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error inquiring '//TRIM(Filename)//' for '//TIME_DATA_VARNAME//&
            ' variable ID - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Write_Cleanup(); RETURN
    END IF
    NF90_Status = NF90_PUT_VAR( FileId,VarID,RadDiag_Stats%time_Data )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error writing '//TIME_DATA_VARNAME//' to '//TRIM(Filename)//&
            ' - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Write_Cleanup(); RETURN
    END IF
...
!------------------------------------------------------------------------------
  ...
  RESULT( err_stat )
    ...
    IF ( NF90_Status /= NF90_NOERR ) THEN
      ...
      CALL Read_Cleanup(); RETURN
    END IF
    NF90_Status = NF90_GET_VAR( FileId,VarID,RadDiag_Stats%scan_Data )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error reading '//SCAN_DATA_VARNAME//' from '//TRIM(Filename)//&
            ' - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Read_Cleanup(); RETURN
    END IF
    ! ...scan_nSamples variable 
    ...
    IF ( NF90_Status /= NF90_NOERR ) THEN
      ...
      CALL Read_Cleanup(); RETURN
    END IF
    NF90_Status = NF90_GET_VAR( FileId,VarID,RadDiag_Stats%time_Data )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error reading '//TIME_DATA_VARNAME//' from '//TRIM(Filename)//&
            ' - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Read_Cleanup(); RETURN
    END IF
    ! ...time_nSamples variable 
 ...
 CONTAINS
  ...
  RESULT( err_stat )
    ...
    NF90_Status = NF90_DEF_VAR( FileID, &
                                ...
                                varID=VarID )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error defining '//SCAN_DATA_VARNAME//' variable in '//&
            TRIM(Filename)//' - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Create_Cleanup(); RETURN
    END IF
    Put_Status(1) = NF90_PUT_ATT( FileID,VarID,LONGNAME_ATTNAME   ,SCAN_DATA_LONGNAME    )
    Put_Status(2) = NF90_PUT_ATT( FileID,VarID,DESCRIPTION_ATTNAME,SCAN_DATA_DESCRIPTION )
    Put_Status(3) = NF90_PUT_ATT( FileID,VarID,UNITS_ATTNAME      ,SCAN_DATA_UNITS       )
    Put_Status(4) = NF90_PUT_ATT( FileID,VarID,FILLVALUE_ATTNAME  ,SCAN_DATA_FILLVALUE   )
    IF ( ANY(Put_Status /= NF90_NOERR) ) THEN
      msg = 'Error writing '//SCAN_DATA_VARNAME//' variable attributes to '//TRIM(Filename)
      CALL Create_Cleanup(); RETURN
    END IF
    ! ...scan_nSamples variable
    NF90_Status = NF90_DEF_VAR( FileID, &
    ...
    NF90_Status = NF90_DEF_VAR( FileID, &
                                ...
                                varID=VarID )
    IF ( NF90_Status /= NF90_NOERR ) THEN
      msg = 'Error defining '//TIME_DATA_VARNAME//' variable in '//&
            TRIM(Filename)//' - '//TRIM(NF90_STRERROR( NF90_Status ))
      CALL Create_Cleanup(); RETURN
    END IF
    Put_Status(1) = NF90_PUT_ATT( FileID,VarID,LONGNAME_ATTNAME   ,TIME_DATA_LONGNAME    )
    Put_Status(2) = NF90_PUT_ATT( FileID,VarID,DESCRIPTION_ATTNAME,TIME_DATA_DESCRIPTION )
    Put_Status(3) = NF90_PUT_ATT( FileID,VarID,UNITS_ATTNAME      ,TIME_DATA_UNITS       )
    Put_Status(4) = NF90_PUT_ATT( FileID,VarID,FILLVALUE_ATTNAME  ,TIME_DATA_FILLVALUE   )
    IF ( ANY(Put_Status /= NF90_NOERR) ) THEN
      msg = 'Error writing '//TIME_DATA_VARNAME//' variable attributes to '//TRIM(Filename)
      CALL Create_Cleanup(); RETURN
    END IF
    ! ...time_nSamples variable
    NF90_Status = NF90_DEF_VAR( FileID, &
