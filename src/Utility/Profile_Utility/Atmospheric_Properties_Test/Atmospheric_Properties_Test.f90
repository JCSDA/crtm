...
PROGRAM Atmospheric_Properties_Test
  ...
  ! ----------------
  ! Module usage
  USE Profile_Utility, fp=>fp_kind
  ...
  CHARACTER( * ), PARAMETER :: PROGRAM_RCS_ID = &
    '$Id: Atmospheric_Properties_Test.f90,v 1.3 2006/05/05 19:21:48 wd20pd Exp $'
  ! The dimension
  ...
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: PRESSURE = &
  ...
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: TEMPERATURE = &
  (/ 299.70_fp, 293.70_fp, 287.70_fp, 283.70_fp, &
     ...
     299.70_fp, 380.00_fp /)
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: WATER_VAPOR = &
  ...
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: CARBON_DIOXIDE = &
  ...
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: OZONE = &
  ...
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: CARBON_MONOXIDE = &
  ...
  REAL( fp ), PARAMETER, DIMENSION( N_LEVELS ) :: METHANE = &
  ...
  CALL Program_Message( PROGRAM_NAME, &
                        'Program to test the Atmopsheric_Properties module routines.', &
                        '$Revision: 1.3 $' )
  ...
  WRITE( *, '( /5x, "MW_Air test. The following value must be 0.0 : ", es13.6 )' ) &
            MW_Test - MW_Answer
  ...
  WRITE( *, '( /5x, "Density test. The following value must be 1.0 : ", es13.6 )' ) Rho_Test
  ...
  WRITE( *, '( /5x, "Virtual_Temperature FORWARD test. The following value must be 0.0 : ", es13.6 )' ) &
            Tv_Test - Tv_Answer
  Tvi_Test   = Virtual_Temperature( Tv_Test, W_Test, Inverse = 1 )
  Tvi_Answer = T_Test
  WRITE( *, '(  5x, "Virtual_Temperature INVERSE test. The following value must be 0.0 : ", es13.6 )' ) &
            Tvi_Test - Tvi_Answer
  ...
  Theta_Answer = T0
  WRITE( *, '( /5x, "Potential_Temperature FORWARD test. The following value must be 0.0 : ", es13.6 )' ) &
            Theta_Test - Theta_Answer
  T_Test   = Potential_Temperature( Theta_Test, P_Test, INVERSE = 1 )
  T_Answer = T0
  WRITE( *, '(  5x, "Potential_Temperature INVERSE test. The following value must be 0.0 : ", es13.6 )' ) &
            T_Test - T_Answer
