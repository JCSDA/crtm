...
!
! PURPOSE:
!       Subroutine to clear the scalar members of a CRTMstats structure.
!
! CATEGORY:
!       CRTM : CRTMstats
!
...
!
! CALLING SEQUENCE:
!       CALL Clear_CRTMstats( CRTMstats ) ! Output
!
! INPUT ARGUMENTS:
!       None.
!
...
!
! OUTPUT ARGUMENTS:
!       CRTMstats:  CRTMstats structure for which the scalar members have
!                    been cleared.
!                    UNITS:      N/A
!                    TYPE:       CRTMstats_type
!                    DIMENSION:  Scalar
...
!
! COMMENTS:
!       Note the INTENT on the output CRTMstats argument is IN OUT rather than
...
!
! CALLING SEQUENCE:
!       Association_Status = Associated_CRTMstats( CRTMstats,         &  ! Input
!                                                   ANY_Test = Any_Test )  ! Optional input
!
! INPUT ARGUMENTS:
!       CRTMstats:  CRTMstats structure which is to have its pointer
...
!                    CRTMstats structure pointer members are associated.
...
!                            association status of the CRTMstats pointer
!                            members.
!                            .TRUE.  - if ALL the CRTMstats pointer members
!                                      are associated, or if the ANY_Test argument
!                                      is set and ANY of the CRTMstats pointer
!                                      members are associated.
!                            .FALSE. - some or all of the CRTMstats pointer
...
!
! RESTRICTIONS:
!       This function tests the association status of the CRTMstats
!       structure pointer members. Therefore this function must only
!       be called after the input CRTMstats structure has, at least,
...
! 
! PURPOSE:
!       Function to re-initialize the scalar and pointer members of CRTMstats
!       data structures.
!
! CATEGORY:
!       CRTM : CRTMstats
...
!
! CALLING SEQUENCE:
!       Error_Status = Destroy_CRTMstats( CRTMstats,               &  ! Output
...
!
! OUTPUT ARGUMENTS:
!       CRTMstats:   Re-initialised CRTMstats structure.
!                     UNITS:      N/A
!                     TYPE:       CRTMstats_type
!                     DIMENSION:  Scalar
!                     ATTRIBUTES: INTENT( IN OUT )
...
!
! CALLS:
!       Associated_CRTMstats:  Function to check the association status of
!                               the CRTMstats pointer components.
!
!       Clear_CRTMstats:       Function to clear the scalar members of a
!                               CRTMstats structure.
!
...
! 
! PURPOSE:
!       Function to allocate the pointer members of the CRTMstats
!       data structure.
!
! CATEGORY:
!       CRTM : CRTMstats
...
!
! OUTPUT ARGUMENTS:
!       CRTMstats:       CRTMstats structure with allocated
!                         pointer members
!                         UNITS:      N/A
!                         TYPE:       CRTMstats_type
!                         DIMENSION:  Scalar
...
!
! CALLS:
!       Associated_CRTMstats:  Function to test the association status of the
!                               pointer members of a CRTMstats structure.
!
!       Destroy_CRTMstats:     Function to re-initialize the scalar and pointer
!                               members of CRTMstats data structures.
!
!       Display_Message:        Subroutine to output messages
!                               SOURCE: ERROR_HANDLER module
!
...
!
! PURPOSE:
!       Function to copy valid CRTMstats structures.
!
! CATEGORY:
!       CRTM : CRTMstats
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Assign_CRTMstats( CRTMstats_in,            &  ! Input
!                                         CRTMstats_out,           &  ! Output
!                                         RCS_Id = RCS_Id,          &  ! Revision control
!                                         Message_Log = Message_Log )  ! Error messaging
!
! INPUT ARGUMENTS:
!       CRTMstats_in:  CRTMstats structure which is to be copied.
!                       UNITS:      N/A
!                       TYPE:       CRTMstats_type
!                       DIMENSION:  Scalar
!                       ATTRIBUTES: INTENT( IN )
...
!
! OUTPUT ARGUMENTS:
!       CRTMstats_out: Copy of the input structure, CRTMstats_in.
!                       UNITS:      N/A
!                       TYPE:       CRTMstats_type
!                       DIMENSION:  Scalar
!                       ATTRIBUTES: INTENT( IN OUT )
...
!                               pointer members of a CRTMstats structure.
!
!       Allocate_CRTMstats:    Function to allocate the pointer members of
!                               the CRTMstats data structure.
!
!       Display_Message:        Subroutine to output messages
!                               SOURCE: ERROR_HANDLER module
!
...
!S+
! NAME:
!       Concatenate_CRTMstats
!
! PURPOSE:
!       Function to concatenate two valid CRTMstats structures along
...
!
! CALLING SEQUENCE:
!       Error_Status = Concatenate_CRTMstats( CRTMstats1,              &  ! Input/Output
!                                              CRTMstats2,              &  ! Input
!                                              RCS_Id = RCS_Id,          &  ! Revision control
!                                              Message_Log = Message_Log )  ! Error messaging
!
! INPUT ARGUMENTS:
!       CRTMstats1:   First CRTMstats structure to concatenate.
!                      UNITS:      N/A
!                      TYPE:       CRTMstats_type
!                      DIMENSION:  Scalar
!                      ATTRIBUTES: INTENT( IN OUT )
!
!       CRTMstats2:   Second CRTMstats structure to concatenate.
!                      UNITS:      N/A
!                      TYPE:       CRTMstats_type
!                      DIMENSION:  Scalar
!                      ATTRIBUTES: INTENT( IN )
...
!
! OUTPUT ARGUMENTS:
!       CRTMstats1:   The concatenated CRTMstats structure. The order of
!                      concatenation is CRTMstats1,CRTMstats2 along the 
!                      channel dimension.
!                      UNITS:      N/A
!                      TYPE:       CRTMstats_type
!                      DIMENSION:  Scalar
...
!                         == FAILURE an error occurred, or
!                         == WARNING - the version numbers of the CRTMstats structure
!                                      data are different.
!                                    - the destruction of a temporary, local CRTMstats
!                                      structure failed.
!                      UNITS:      N/A
!                      TYPE:       INTEGER
!                      DIMENSION:  Scalar
!
! CALLS:
!       Initialize_CRTMstats:    Function to initialize the scalar and pointer
!                                 members of CRTMstats data structures.
!
!       Associated_CRTMstats:    Function to test the association status of the
!                                 pointer members of a CRTMstats structure.
!
!       Assign_CRTMstats:        Function to copy valid CRTMstats data structures.
!
!       Destroy_CRTMstats:       Function to re-initialize the scalar and pointer
!                                 members of CRTMstats data structures.
!
...
!                                 the CRTMstats data structure.
!
!       Count_CRTMstats_Sensors: Subroutine to count the number of different
!                                 satellite/sensors in the CRTMstats structure
...
!
! SIDE EFFECTS:
!       The input CRTMstats1 argument contains the concatenated structure
!       data (in character-speak: CRTMstats1//CRTMstats2) on output. It is
!       reallocated within this routine so if an error occurs during the
!       reallocation, the contents of the input CRTMstats1 structure will
!       be lost.
!
...
! 
! PURPOSE:
!       Function to compute the statistics for an CRTMstats data structure.
!
! CATEGORY:
!       CRTM : CRTMstats
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Compute_CRTMstats( CRTMstats,                &  ! In/Output
!                                          RCS_Id = RCS_Id,           &  ! Revision control
!                                          Message_Log = Message_Log  )  ! Error messaging
!
! INPUT ARGUMENTS:
!       CRTMstats:       CRTMstats structure with the TOA transmittance
...
!
! OUTPUT ARGUMENTS:
!       CRTMstats:       CRTMstats structure with the mean and RMS
...
!
! SIDE EFFECTS:
!       The statistics components of the input CRTMstats argument are filled
!       in this routine.
!
! RESTRICTIONS:
!       None.
...
!S+
! NAME:
!       Count_CRTMstats_Sensors
!
! PURPOSE:
!       Subroutine to count the number of different satellite/sensors in the
!       CRTMstats structure and set the n_Sensors field.
!
! CATEGORY:
!       CRTM : CRTMstats
!
...
!
! CALLING SEQUENCE:
!       CALL Count_CRTMstats_Sensors( CRTMstats,              &  ! In/Output
!                                      Use_WMO_ID = Use_WMO_ID, &  ! Optional input
!                                      RCS_Id = RCS_Id          )  ! Revision control
!
! INPUT ARGUMENTS:
!       CRTMstats_in: Filled CRTMstats structure.
!                      UNITS:      N/A
!                      TYPE:       CRTMstats_type
!                      DIMENSION:  Scalar
!                      ATTRIBUTES: INTENT( IN OUT )
...
!                      IDs in the CRTMstats structure to count the number of
...
!
! SIDE EFFECTS:
!       The N_SENSORS component of the CRTMstats structure is modified.
!
! RESTRICTIONS:
!       None.
!
...
!
! CALLING SEQUENCE:
!       CALL Information_CRTMstats( CRTMstats,     &  ! Input
!                                    Information,    &  ! Output
!                                    RCS_Id = RCS_Id )  ! Revision control
! 
! INPUT ARGUMENTS:
!       CRTMstats:    Filled CRTMstats structure.
!                      UNITS:      N/A
!                      TYPE:       CRTMstats_type
!                      DIMENSION:  Scalar
!                      ATTRIBUTES: INTENT( IN )
