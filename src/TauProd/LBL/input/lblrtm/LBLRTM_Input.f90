...
MODULE LBLRTM_Input
  ...
  PRIVATE
!  PUBLIC :: create_lblrtm_tape7
  PUBLIC :: create_LBLRTM_TAPE5
...
!
! PURPOSE:
!       Function to create an input TAPE5 file for LBLRTM
!
! CATEGORY:
!       LBLRTM
!
...
!                           ATTRIBUTES: INTENT( IN )
!
!       absorber_amount:    Absorber amounts to use in the LBLRTM calculation.
...
!                           correspond to the HITRAN/LBLRTM molecular species
!                           numbers:
...
!                              boundaries defining the LBLRTM calculation layers.
...
!                              ATTRIBUTES: OPTIONAL, INTENT( IN )
!
!       continuum_option:      Set this argument to the LBLRTM continuum option.
!                              Valid values are:
!                                0 = no continua
!
...
!                              ATTRIBUTES: OPTIONAL, INTENT( IN )
!
!       merge_option:          Set this argument to the LBLRTM merge option.
!                              See the LBLRTM instructions for valid values.
!                              If not specified, the default value is 0.
!                              UNITS:      N/A
!                              TYPE:       INTEGER
!                              DIMENSION:  Scalar
...
!                              ATTRIBUTES: OPTIONAL, INTENT( IN )
!
!       xsection_amount:       X-section absorber amounts to use in the LBLRTM
...
!                              to those used by LBLRTM and are:
!                                'A':     Volume mixing ratio (ppmv)
...
!                              default value is:
!                              'LBLRTM TAPE5. Created on YYYY/MM/DD at HH:MM:SS'
!                              Units:     None
!                              Type:      Character
...
!                                   level altitudes for LBLRTM TAPE5 files.
!       
! EXTERNALS:
...
!
! RESTRICTIONS:
!        - Maximum number of input profile levels is 3400. This is an LBLRTM
!          requirement and may change.
!        - Maximum number of calculation levels is 200. This is an LBLRTM
!          requirement and may change.
...
!--------------------------------------------------------------------------------
  ...
  FUNCTION create_LBLRTM_TAPE5( pressure,             &  ! Input
                                temperature,          &  ! Input
                                absorber_amount,      &  ! Input
                                absorber_units,       &  ! Input
                                absorber_id,          &  ! Input
    ...
    ! -- Routine name
    CHARACTER( * ),  PARAMETER :: ROUTINE_NAME = 'Create_LBLRTM_TAPE5'
...
!    END IF
    ...
    ELSE
      ...
      WRITE( user_header, FMT = '( "LBLRTM TAPE5. Created on ", &
                                  &i4,"/",i2.2,"/",i2.2," at ", &
                                  &i2.2,":",i2.2,":",i2.2 )' ) &
...
!                                             altitude        = altitude,        &  ! Optional input
  ...
  END FUNCTION create_LBLRTM_TAPE5
...
!================================================================================
  ...
  FUNCTION Write_Record_3p1( file_id,       &  ! Input
    ...
    WRITE( file_id, FMT    = '( 7( i5 ), i2, 1x, i2, 5( f10.3 ) )', &
