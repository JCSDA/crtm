...
C     *********************************************************          FA03810
C                                                                        FA03820
      COMMON /PATHD/ PBAR(MXLAY),TBAR(MXLAY),AMOUNT(MXMOL,MXLAY),        FA03830
     *               WN2L(MXLAY),DVL(MXLAY),WTOTL(MXLAY),ALBL(MXLAY),    FA03840
...
C                                                                        FA47210
     ...
     *               ITYL(MXLAY),SECNTA(MXLAY),HT1,HT2,ALTZ(0:MXLAY),    FA47260
...
C                                                                        FX00630
      ...
      COMMON /PATHD/ PBAR(MXLAY),TBAR(MXLAY),AMOUNT(MXMOL,MXLAY),        FX00650
     *               WN2L(MXLAY),DVL(MXLAY),WTOTL(MXLAY),ALBL(MXLAY),    FX00660
...
C                                                                        FX04520
         IF (IZORP .EQ. 0) THEN
            DO 50 L = 1, LAYX                                               FX04530
               READ (IRD,925) ZX(L),(JCHAR(I,L),I=1,IXMOLS)                 FX04540
               WRITE (IPR,930) ZX(L),(JCHAR(I,L),I=1,IXMOLS)                FX04550
C                                                                           FX04560
               READ (IRD,935) (DTMP(K,L),K=1,IXMOLS)                        FX04670
               WRITE (IPR,940) (DTMP(K,L),K=1,IXMOLS)                       FX04680
 50         CONTINUE                                                        FX04780
         ELSE
            DO 60 L = 1, LAYX                                               FX04530
               READ (IRD,925) PX(L),(JCHAR(I,L),I=1,IXMOLS)                 FX04540
               WRITE (IPR,930) PX(L),(JCHAR(I,L),I=1,IXMOLS)                FX04550
C                                                                           FX04560
               READ (IRD,935) (DTMP(K,L),K=1,IXMOLS)                        FX04670
               WRITE (IPR,940) (DTMP(K,L),K=1,IXMOLS)                       FX04680
 60         CONTINUE
