...
!
! PURPOSE:
!       Function to return the requested profile from the standard Model
!       Climatology set of atmospheric profiles.
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Load_Model_Profile( Profile,                               &  ! Input
...
!                           ATTRIBUTES: OPTIONAL, INTENT( OUT )
!
!       Year:               Year in which the requested profile was created.
!                           UNITS:      N/A
!                           TYPE:       INTEGER
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: OPTIONAL, INTENT( OUT )
!
!       Month:              Month in which the requested profile was created.
!                           UNITS:      N/A
!                           TYPE:       INTEGER
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: OPTIONAL, INTENT( OUT )
!
!       Day:                Day on which the requested profile was created.
!                           UNITS:      N/A
!                           TYPE:       INTEGER
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: OPTIONAL, INTENT( OUT )
!
!       Hour:               Hour in which the requested profile was created.
!                           UNITS:      UTC
!                           TYPE:       INTEGER
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: OPTIONAL, INTENT( OUT )
...
!                        == FAILURE - an invalid profile number was specified, or
...
!--------------------------------------------------------------------------------
  ...
  FUNCTION Load_Model_Profile ( Profile,      &  ! Input
    ...
    H2O_Mixing_Ratio = PPMV_to_MR( Level_Absorber(:,1) )
