...
!
! CATEGORY:
!       Surface : MW Surface Snow Emissivity from SSMI
!
! LANGUAGE:
!       Fortran-95
!
...
!   PUBLIC SUBPROGRAM:
!
!       NESDIS_SSMI_SnowEM : Subroutine to call SSMI_SnowEM_CORE
!
!   PRIVATE SUBPROGRAM:
!
...
!
!       Fixed bugs:    Banghua Yan, Yong Han and QuanLiu   (10-September-2005)
!
!
...
!snow
  data (coe_v(1,k),k=1,5)/  1.109066e-001_fp_kind,  5.449409e-003_fp_kind,  &
       1.835799e-004_fp_kind, -1.765248e-003_fp_kind, -2.996101e-004_fp_kind/
  data (coe_v(2,k),k=1,5)/ 9.356505e-002_fp_kind,  1.320617e-003_fp_kind,  &
       4.449195e-003_fp_kind, -1.786960e-003_fp_kind, -3.479687e-004_fp_kind/
  data (coe_v(3,k),k=1,5)/ 6.387097e-002_fp_kind,  1.252447e-003_fp_kind,  &
       1.998846e-004_fp_kind, 2.680219e-003_fp_kind, -3.740141e-004_fp_kind/
  data (coe_v(4,k),k=1,5)/ 4.150689e-002_fp_kind,  1.420274e-003_fp_kind,  &
