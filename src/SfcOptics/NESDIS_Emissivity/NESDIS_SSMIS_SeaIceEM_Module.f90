...
!
! CATEGORY:
!       Surface : MW Surface Sea Ice Emissivity from SSMIS
!
! LANGUAGE:
!       Fortran-95
!
! CALLING SEQUENCE:
!       USE NESDIS_SSMIS_SeaIceEM_Module
!
! MODULES:
...
!
!   PUBLIC SUBPROGRAM:
!       NESDIS_SSMIS_IceEM : Subroutine to call SSMIS_SeaIceEM
!
!   PRIVATE SUBPROGRAM:
!
!       SSMIS_IceEM_TBTS : Subroutine to calculate the microwave emissivity over seaice conditions using Tb & TS
!       SSMIS_IceEM_TB  : Subroutine to calculate the microwave emissivity over seaice conditions using Tb
!
! INCLUDE FILES:
!       None.
!
