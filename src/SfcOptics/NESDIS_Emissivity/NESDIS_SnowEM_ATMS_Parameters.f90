...
MODULE NESDIS_SnowEM_ATMS_Parameters
   ...
   INTEGER(ip), PUBLIC, PARAMETER :: N_SNOW_TYPES = 16
   ...
   INTEGER(ip),PUBLIC,PARAMETER, DIMENSION(N_SNOW_TYPES) :: Code2Excel_Idx =  &
         (/2, 1,  4, 11, 14, 12,  8, 16, 10, 15, 13,  5,  6,  3,  7,  9/)
   INTEGER(ip),PUBLIC,PARAMETER, DIMENSION(N_SNOW_TYPES) :: Excel2Code_Idx =  & 
