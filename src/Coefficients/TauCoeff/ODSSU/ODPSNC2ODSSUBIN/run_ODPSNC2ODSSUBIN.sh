...
usage()
{
  echo " Usage: run_ODPSNC2ODSSUBIN.sh -l|b[fh]"
  echo
  echo "   Convert any netCDF format ODPS SSU TauCoeff files in the current"
...
SSU_SENSOR_ID_LIST="ssu_tirosn ssu_n06 ssu_n07 ssu_n08 ssu_n09 ssu_n11 ssu_n14 ssu_pseudo"
