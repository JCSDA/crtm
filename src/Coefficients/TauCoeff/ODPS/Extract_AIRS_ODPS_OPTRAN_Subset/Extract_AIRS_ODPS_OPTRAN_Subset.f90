!
! Extract_AIRS_ODPS_OPTRAN_Subset
!
...
PROGRAM Extract_AIRS_ODPS_OPTRAN_Subset
  ...
  ! Parameters
  ! ----------
  CHARACTER(*), PARAMETER :: PROGRAM_NAME = 'Extract_AIRS_ODPS_OPTRAN_Subset'
  ...
  SELECT CASE ( Set )
    ...
    CASE (4)
      ...
      WRITE( Sensor_ID,'("airs",i0,"USER_aqua")' ) n_Subset_Channels
...
END PROGRAM Extract_AIRS_ODPS_OPTRAN_Subset
