...
!
!       ODCAPS_Subset_Define:Module defining the ODCAPS_Subset data structure and
...
!
! CONTAINS:
!       Inquire_ODCAPS_Subset_Binary: Function to inquire a Binary format
!                                       ODCAPS_Subset file.
!
!       Read_ODCAPS_Subset_Binary:    Function to read a Binary format
!                                       ODCAPS_Subset file.
!
!       Write_ODCAPS_Subset_Binary:   Function to write a Binary format
!                                       ODCAPS_Subset file.
!
! INCLUDE FILES:
!       None.
...
!
! FILES ACCESSED:
!       User specified Binary format ODCAPS_Subset data files for both
!       input and output.
!
! CREATION HISTORY:
...
!S+
! NAME:
!       Inquire_ODCAPS_Subset_Binary
!
! PURPOSE:
!       Function to inquire a Binary format ODCAPS_Subset structure file.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Inquire_ODCAPS_Subset_Binary( Filename,                    &  ! Input
...
!                           ODCAPS_Subset data file to inquire.
!                           UNITS:      N/A
!                           TYPE:       CHARACTER( * )
!                           DIMENSION:  Scalar
...
!S+
! NAME:
!       Read_ODCAPS_Subset_Binary
!
! PURPOSE:
!       Function to read Binary format ODCAPS_Subset files.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Read_ODCAPS_Subset_Binary( Filename,               &  ! Input
!                                            ODCAPS_Subset,               &  ! Output
...
! INPUT ARGUMENTS:
!       Filename:           Character string specifying the name of the binary
!                           format ODCAPS_Subset data file to read.
!                           UNITS:      N/A
!                           TYPE:       CHARACTER( * )
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: INTENT( IN )
...
!
!       No_Allocate:        Set this argument to NOT allocate the output ODCAPS_Subset
...
!
! OUTPUT ARGUMENTS:
!       ODCAPS_Subset:    Structure containing the transmittance coefficient data
!                           read from the file.
!                           UNITS:      N/A
...
!                                of the ODCAPS_Subset structure.
!                                SOURCE: ODCAPS_Subset_DEFINE module
!
!       Display_Message:         Subroutine to output Messages
!                                SOURCE: Message_Handler module
!
...
!S+
! NAME:
!       Write_ODCAPS_Subset_Binary
!
! PURPOSE:
!       Function to write Binary format ODCAPS_Subset files.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Write_ODCAPS_Subset_Binary( Filename,               &   ! Input
!                                             ODCAPS_Subset,               &   ! Input
!                                             No_File_Close = No_File_Close, &  ! Optional input
!                                             RCS_Id        = RCS_Id,        &   ! Revision control
!                                             Message_Log   = Message_Log    )   ! Error messaging
...
!                     ODCAPS_Subset format data file.
!                     UNITS:      N/A
!                     TYPE:       CHARACTER( * )
!                     DIMENSION:  Scalar
!                     ATTRIBUTES: INTENT( IN )
!
!       ODCAPS_Subset:Structure containing the gas absorption coefficient data.
!                     UNITS:      N/A
!                     TYPE:       ODCAPS_Subset_type
!                     DIMENSION:  Scalar
!                     ATTRIBUTES: INTENT( IN )
...
!                        == FAILURE - the input ODCAPS_Subset structure contains
