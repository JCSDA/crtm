...
!
! NAME:
!       Clear_TauCoeff_TraceGas
!
! PURPOSE:
!       Subroutine to clear the scalar members of a TauCoeff_TraceGas structure.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       CALL Clear_TauCoeff_TraceGas( TauCoeff_TraceGas ) ! Output
!
! INPUT ARGUMENTS:
!       None.
!
...
!
! OUTPUT ARGUMENTS:
!       TauCoeff_TraceGas:  TauCoeff_SARTA_TraceGas structure for which the scalar members have
!                           been cleared.
!                           UNITS:	N/A
!                           TYPE:	TauCoeff_SARTA_TraceGas_type
!                           DIMENSION:  Scalar
...
!
! COMMENTS:
!       Note the INTENT on the output TauCoeff_SARTA_TraceGas argument is IN OUT rather than
...
!S+
! NAME:
!       Associated_TauCoeff_TraceGas
!
! PURPOSE:
!       Function to test the association status of the pointer members of a
!       TauCoeff_SARTA_TraceGas structure.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Association_Status = Associated_TauCoeff_TraceGas( TauCoeff_TraceGas,           &  ! Input
!                                                 ANY_Test = Any_Test )  ! Optional input
!
! INPUT ARGUMENTS:
!       TauCoeff_TraceGas:    TauCoeff_SARTA_TraceGas structure which is to have its pointer
...
!                    TauCoeff_SARTA_TraceGas structure pointer members are associated.
...
!                            association status of the TauCoeff_SARTA_TraceGas pointer members.
!                            .TRUE.  - if ALL the TauCoeff_SARTA_TraceGas pointer members are
!                                      associated, or if the ANY_Test argument
!                                      is set and ANY of the TauCoeff_SARTA_TraceGas pointer
!                                      members are associated.
!                            .FALSE. - some or all of the TauCoeff_SARTA_TraceGas pointer
...
!
! RESTRICTIONS:
!       This function tests the association status of the TauCoeff_SARTA_TraceGas
!       structure pointer members. Therefore this function must only
!       be called after the input TauCoeff_SARTA_TraceGas structure has, at least,
...
!S+
! NAME:
!       Destroy_TauCoeff_TraceGas
! 
! PURPOSE:
!       Function to re-initialize the scalar and pointer members of TauCoeff_SARTA_TraceGas
!       data structures.
!
! CATEGORY:
!       Optical Depth : Coefficients
...
!
! CALLING SEQUENCE:
!       Error_Status = Destroy_TauCoeff_TraceGas( TauCoeff_TraceGas,      &  ! Output
...
!
! OUTPUT ARGUMENTS:
!       TauCoeff_TraceGas:Re-initialized TauCoeff_SARTA_TraceGas structure.
!                     UNITS:      N/A
!                     TYPE:       TauCoeff_SARTA_TraceGas_type
!                     DIMENSION:  Scalar
!                     ATTRIBUTES: INTENT( IN OUT )
...
!
! CALLS:
!       Associated_TauCoeff_TraceGas:  Function to test the association status of the
!                             pointer members of a TauCoeff_SARTA_TraceGas structure.
!
...
!S+
! NAME:
!       Allocate_TauCoeff_TraceGas
! 
! PURPOSE:
!       Function to allocate the pointer members of the TauCoeff_SARTA_TraceGas
!       data structure.
!
! CATEGORY:
!       Optical Depth : Coefficients
...
!
! CALLING SEQUENCE:
!       Error_Status = Allocate_TauCoeff_TraceGas( n_Layers,                &  ! Input	        
!                                                n_Predictors,	          &  ! Input	        
!                                                n_Channels,		  &  ! Input	        
...
!
! OUTPUT ARGUMENTS:
!       TauCoeff_TraceGas:     TauCoeff_SARTA_TraceGas structure with allocated
!                     pointer members
!                     UNITS:      N/A
!                     TYPE:       TauCoeff_SARTA_TraceGas_type
!                     DIMENSION:  Scalar
...
!                             pointer members of a TauCoeff_SARTA_TraceGas structure.
!
!       Destroy_TauCoeff_TraceGas:     Function to re-initialize the scalar and pointer
!                             members of TauCoeff_SARTA_TraceGas data structures.
!
!       Display_Message:      Subroutine to output messages
!                             SOURCE: Message_Handler module
!
...
!S+
! NAME:
!       Assign_TauCoeff_TraceGas
!
! PURPOSE:
!       Function to copy valid TauCoeff_SARTA_TraceGas structures.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Assign_TauCoeff_TraceGas( TauCoeff_TraceGas_in,       &  ! Input
!                                              TauCoeff_TraceGas_out,	 &  ! Output    
!                                              RCS_Id	   = RCS_Id,	 &  ! Revision control 
!                                              Message_Log = Message_Log )  ! Error messaging  
!
! INPUT ARGUMENTS:
!       TauCoeff_TraceGas_in:   TauCoeff_SARTA_TraceGas structure which is to be copied.
!                      UNITS:      N/A
!                      TYPE:       TauCoeff_SARTA_TraceGas_type
!                      DIMENSION:  Scalar
!                      ATTRIBUTES: INTENT( IN )
...
!
! OUTPUT ARGUMENTS:
!       TauCoeff_TraceGas_out:  Copy of the input structure, TauCoeff_SARTA_TraceGas_in.
!                      UNITS:      N/A
!                      TYPE:       TauCoeff_SARTA_TraceGas_type
!                      DIMENSION:  Scalar
!                      ATTRIBUTES: INTENT( IN OUT )
...
!                             pointer members of a TauCoeff_SARTA_TraceGas structure.
!
!       Allocate_TauCoeff_TraceGas:    Function to allocate the pointer members of
!                             the TauCoeff_SARTA_TraceGas data structure.
!
!       Display_Message:      Subroutine to output messages
!                             SOURCE: Message_Handler module
!
...
!S+
! NAME:
!       Zero_TauCoeff_TraceGas
! 
! PURPOSE:
!       Subroutine to zero-out all members of a TauCoeff_TraceGas structure - both
!       scalar and pointer.
!
! CATEGORY:
...
!
! CALLING SEQUENCE: 
!       CALL Zero_TauCoeff_TraceGas( TauCoeff_TraceGas)
!
! INPUT ARGUMENTS:
!       None.
!
...
!
! OUTPUT ARGUMENTS:
!       TauCoeff_TraceGas:Zero TauCoeff_SARTA_TraceGas structure.
!                     UNITS:      N/A
!                     TYPE:       TauCoeff_SARTA_TraceGas_type
!                     DIMENSION:  Scalar
!                                   OR
