...
!S+
! NAME:
!       Inquire_TauCoeff_TraceGas_Bin
!
! PURPOSE:
!       Function to inquire a Binary format TauCoeff_SARTA_TraceGas structure file.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Inquire_TauCoeff_TraceGas_Binary( Filename,                    &  ! Input
...
!                           TauCoeff_SARTA_TraceGas data file to inquire.
!                           UNITS:      N/A
!                           TYPE:       CHARACTER( * )
!                           DIMENSION:  Scalar
...
!S+
! NAME:
!       Read_TauCoeff_TraceGas_Binary
!
! PURPOSE:
!       Function to read Binary format TauCoeff_SARTA_TraceGas files.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Read_TauCoeff_TraceGas_Binary( Filename,               &  ! Input
!                                            TauCoeff_TraceGas,               &  ! Output
...
! INPUT ARGUMENTS:
!       Filename:           Character string specifying the name of the binary
!                           format TauCoeff_SARTA_TraceGas data file to read.
!                           UNITS:      N/A
!                           TYPE:       CHARACTER( * )
!                           DIMENSION:  Scalar
!                           ATTRIBUTES: INTENT( IN )
...
!
!       No_Allocate:        Set this argument to NOT allocate the output TauCoeff_SARTA_TraceGas
...
!
! OUTPUT ARGUMENTS:
!       TauCoeff_TraceGas:    Structure containing the transmittance coefficient data
!                           read from the file.
!                           UNITS:      N/A
...
!                                of the TauCoeff_SARTA_TraceGas structure.
!                                SOURCE: TauCoeff_SARTA_TraceGas_DEFINE module
!
!       Display_Message:         Subroutine to output Messages
!                                SOURCE: Message_Handler module
!
...
!S+
! NAME:
!       Write_TauCoeff_TraceGas_Binary
!
! PURPOSE:
!       Function to write Binary format TauCoeff_SARTA_TraceGas files.
!
! CATEGORY:
!       Optical Depth : Coefficients
!
...
!
! CALLING SEQUENCE:
!       Error_Status = Write_TauCoeff_TraceGas_Binary( Filename,               &   ! Input
!                                             TauCoeff_TraceGas,               &   ! Input
!                                             No_File_Close = No_File_Close, &  ! Optional input
!                                             RCS_Id        = RCS_Id,        &   ! Revision control
!                                             Message_Log   = Message_Log    )   ! Error messaging
...
!                     TauCoeff_SARTA_TraceGas format data file.
!                     UNITS:      N/A
!                     TYPE:       CHARACTER( * )
!                     DIMENSION:  Scalar
!                     ATTRIBUTES: INTENT( IN )
!
!       TauCoeff_TraceGas:Structure containing the gas absorption coefficient data.
!                     UNITS:      N/A
!                     TYPE:       TauCoeff_SARTA_TraceGas_type
!                     DIMENSION:  Scalar
!                     ATTRIBUTES: INTENT( IN )
...
!                        == FAILURE - the input TauCoeff_SARTA_TraceGas structure contains
