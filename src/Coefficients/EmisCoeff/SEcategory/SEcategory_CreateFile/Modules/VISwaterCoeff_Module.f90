MODULE VISwaterCoeff_Module
  ...
  ! ----------
  PRIVATE
  PUBLIC :: VISwaterCoeff_CreateFile
  ...
  CHARACTER(*), PARAMETER :: SURFACE_TYPE_NAME = 'water'
  CHARACTER(*), PARAMETER :: MODULE_NAME = 'VIS'//SURFACE_TYPE_NAME//'Coeff_Module'
...
!################################################################################
  ...
  SUBROUTINE VISwaterCoeff_CreateFile()
    ! Local variables
    ...
    ! Write data to file
    CALL Write_File(npoess, visible = .TRUE.)
  
    ! Cleanup
    CALL SEcategory_Destroy( npoess )

  END SUBROUTINE VISwaterCoeff_CreateFile
...
!################################################################################
  ...
  SUBROUTINE Load_NPOESS_Data(npoess)
    ...
    INTEGER :: i
    DATA (reflectance(i,WATER),i=1,N_WAVELENGTHS)/ &
    0.033_dp, 0.033_dp, 0.033_dp, 0.033_dp, 0.027_dp, 0.027_dp, 0.027_dp, 0.027_dp, &
    0.046_dp, 0.050_dp, 0.052_dp, 0.045_dp, 0.025_dp, 0.024_dp, 0.024_dp, 0.024_dp, &
    0.024_dp, 0.005_dp, 0.005_dp, 0.005_dp, 0.005_dp, 0.006_dp, 0.007_dp, 0.007_dp, &
    0.007_dp, 0.007_dp, 0.007_dp, 0.007_dp, 0.007_dp, 0.024_dp, 0.024_dp, 0.024_dp, &
    0.024_dp, 0.024_dp, 0.024_dp, 0.024_dp, 0.024_dp, 0.024_dp, 0.024_dp, 0.024_dp, &
    0.024_dp, 0.024_dp, 0.024_dp, 0.024_dp, 0.023_dp, 0.023_dp, 0.023_dp, 0.023_dp, &
    0.023_dp, 0.023_dp, 0.023_dp, 0.023_dp, 0.022_dp, 0.001_dp, 0.001_dp, 0.020_dp, &
    0.020_dp, 0.020_dp, 0.020_dp, 0.010_dp, 0.010_dp, 0.020_dp, 0.020_dp, 0.020_dp, &
    0.020_dp, 0.010_dp, 0.010_dp, 0.010_dp, 0.010_dp, 0.010_dp, 0.010_dp, 0.020_dp, &
    0.030_dp, 0.030_dp/
    ! Local variables
    CHARACTER(ML) :: msg
    INTEGER :: n, n_points
    ...
    ! Select indices for visible spectral region
...
END MODULE VISwaterCoeff_Module
