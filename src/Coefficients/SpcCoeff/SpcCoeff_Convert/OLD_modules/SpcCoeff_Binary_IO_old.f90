...
MODULE SpcCoeff_Binary_IO_old
  ...
  USE SpcCoeff_Define_old    , ONLY: SpcCoeff_type, &
                                 Associated_SpcCoeff, &
                                 Allocate_SpcCoeff, &
                                 Destroy_SpcCoeff, &
                                 CheckRelease_SpcCoeff, &
                                 Info_SpcCoeff
  USE AntCorr_Binary_IO_old  , ONLY: Read_AntCorr_Binary, Write_AntCorr_Binary
...
END MODULE SpcCoeff_Binary_IO_old
