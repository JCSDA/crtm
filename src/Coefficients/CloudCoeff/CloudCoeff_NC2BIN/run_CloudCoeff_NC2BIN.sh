...
usage()
{
  echo " Usage: run_CloudCoeff_NC2BIN.sh -l|b[fh]"
  echo
  echo "   Convert any netCDF format CloudCoeff files in the current"
  echo "   directory to Binary format. File with the suffix *CloudCoeff.nc"
  echo "   are converted into *CloudCoeff.bin files."
  echo
