...
\begin{alltt}
  ...
  DO m = 1, N_PROFILES
    ...
    END IF
  END DO\end{alltt}
Note that for the ODAS algorithm the allowed number of absorbers is at most two: that of H\subscript{2}O and O\subscript{3}. For the ODPS algoithm, CO\subscript{2} can also be specified. In future releases, trace gases such as CO, CH\subscript{4}, and N\subscript{2}O will also be accepted as input.

\subsubsection{Allocation of the RTSolution structure}
%.....................................................
...
\subsubsection{Filling the Options substructures for SSU and Zeeman model input}
%...............................................................................
As mentioned above, the \hyperref[sec:ssu_input_structure]{\SSUInput} and \hyperref[sec:zeeman_input_structure]{\ZeemanInput} data structures are private. This means the contents of the structure cannot be accessed directly, but via helper subroutines. For example, to set the SSU instrument mission time, one would call the \hyperref[sec:SSU_Input_SetValue_interface]{\f{SSU\_Input\_SetValue}} subroutine,
\begin{alltt}
  ! Set the SSU input data in the options substructure
  CALL \hyperref[sec:SSU_Input_SetValue_interface]{SSU_Input_SetValue}( opt%SSU_Input    , &  ! Object
...
\begin{alltt}
  ...
  CALL \hyperref[sec:Zeeman_Input_SetValue_interface]{Zeeman_Input_SetValue}( opt%Zeeman_Input    , &  ! Object
