...
\begin{figure}[htp]
  ...
  END TYPE CRTM_Atmosphere_type
    ...
    \begin{tabular}{c|c|c|c}
      \textbf{Component} & \textbf{Description} & \textbf{Units} & \textbf{Dimensions} \\
      \hline\hline
      n\_Layers & The number of atmospheric profile layers & N/A & Scalar \\
      \hline
      n\_Absorbers & The number of atmospheric absorbers & N/A & Scalar \\
      \hline
      n\_Clouds & The number of clouds & N/A & Scalar \\
      \hline
...
\begin{figure}[htp]
  ...
  END TYPE CRTM_Cloud_type
    ...
    \centering
    \begin{tabular}{c|c|c|c}
      \textbf{Component} & \textbf{Description} & \textbf{Units} & \textbf{Rank} \\
      \hline\hline
      n\_Layers & The number of atmospheric profile layers & N/A & Scalar \\
      \hline
                            & The number of layers added so as to      &          & \\
  ...
  \caption{CRTM Cloud structure definition and component description.}
...
\begin{figure}[htp]
  ...
  END TYPE CRTM_Aerosol_type
    ...
    \begin{tabular}{c|c|c|c}
      ...
      \rb{n\_Added\_Layers} & extend the input profile to nominal TOA  & \rb{N/A} & \rb{Scalar} \\
      \hline
      Type & The aerosol type (see table \ref{tab:aerosol_type} & N/A & Scalar \\
      \hline
      Effective\_Radius & The aerosol particle $r_{eff}$ profile & \micron & n\_Layers (K) \\
      \hline
      Concentration & The aerosol concentration profile & kg.m$^{-2}$ & n\_Layers (K) \\
    \end{tabular}
  \end{minipage}
  }
  \caption{CRTM Aerosol structure definition and component description.}
