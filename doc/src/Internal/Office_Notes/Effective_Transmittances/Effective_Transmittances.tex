...
\begin{thebibliography}{99}
  \bibitem{ref:crtm_idoc1} van Delst, P., ``Generating IASI resolution transmittances for regression fitting'', CRTM Series, JCSDA Office Note 1, November, 2007.
\end{thebibliography}
...
\begin{appendix}
  ...
  \include{dtb.appendix}
  \include{efftau.appendix}
