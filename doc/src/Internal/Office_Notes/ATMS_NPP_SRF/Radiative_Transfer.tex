...
\begin{figure}[htp]
  ...
  \begin{tabular}{c c}
    ...
    \includegraphics[bb=82 289 312 494,clip,scale=1.0]{graphics/dtb/atms_npp.ch12.TbStats.eps} &
    \includegraphics[bb=82 289 312 494,clip,scale=1.0]{graphics/dtb/atms_npp.ch13.TbStats.eps} \\\\
...
\begin{figure}[htp]
  ...
  \begin{tabular}{c c}
    \textsf{\textbf{(a)} Channel 12} &
    \textsf{\textbf{(b)} Channel 13} \\
    \includegraphics[bb=312 289 538 494,clip,scale=1.0]{graphics/dtb/atms_npp.ch12.TbStats.eps} &
    \includegraphics[bb=312 289 538 494,clip,scale=1.0]{graphics/dtb/atms_npp.ch13.TbStats.eps} \\\\
