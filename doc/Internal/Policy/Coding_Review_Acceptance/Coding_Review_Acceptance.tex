...
\begin{thebibliography}{99}
  \bibitem{ref:crtm_coding_guidelines} van Delst, P., ``CRTM: Fortran95 Coding Guidelines'', JCSDA Report; January, 2008.
  \bibitem{ref:svnbook1} Collins-Sussman, B., B.W.Fitzpatrick, and C.M.Pilato, ``Version Control with Subversion'', 2007. \href{http://svnbook.red-bean.com}{http://svnbook.red-bean.com}
  \bibitem{ref:svnbook2} Mason, M. ``Pragmatic Version Control. Using Subversion.'', The Pragmatic Bookshelf, Raleigh, North Carolina, 2005. \href{http://www.pragmaticprogrammer.com}{http://www.pragmaticprogrammer.com}
\end{thebibliography}
