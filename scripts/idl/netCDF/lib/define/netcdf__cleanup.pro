...
;
; PURPOSE:
;       The netCDF::Cleanup procedure method performs cleanup
;       on an netCDF object when it is destroyed.
;
...
;         or
;
;       Obj->[netCDF::]Cleanup, Debug=Debug  (In a lifecycle method only)
;
...
PRO netCDF::Cleanup, Debug=Debug  ; Input keyword
