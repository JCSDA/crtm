;+
; NAME:
;       LBL_Continuum::Inspect
;
; PURPOSE:
;       The LBL_Continuum::Inspect procedure method outputs information
;       about the current LBL_Continuum object.
;
; CALLING SEQUENCE:
;       Obj->[LBL_Continuum::]Inspect, $
...
;
; EXAMPLE:
;       Inspect the contents of a LBL_Continuum object, x:
;
