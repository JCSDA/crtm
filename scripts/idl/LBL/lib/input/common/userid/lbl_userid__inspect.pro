...
;
; PURPOSE:
;       The LBL_UserId::Inspect procedure method outputs information
;       about the current LBL_UserId object.
;
; CALLING SEQUENCE:
;       Obj->[LBL_UserId::]Inspect, $
...
;
; EXAMPLE:
;       Inspect the contents of a LBL_UserId object, x:
;
