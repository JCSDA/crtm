...
;
; PURPOSE:
;       The LBL_Base::Inspect procedure method outputs information
;       about the current LBL_Base object.
;
; CALLING SEQUENCE:
;       Obj->[LBL_Base::]Inspect, $
...
;
; EXAMPLE:
;       Inspect the contents of a LBL_Base object, x:
;
