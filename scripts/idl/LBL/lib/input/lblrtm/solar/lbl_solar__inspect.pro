...
;
; PURPOSE:
;       The LBL_Solar::Inspect procedure method outputs information
;       about the current LBL_Solar object.
;
; CALLING SEQUENCE:
;       Obj->[LBL_Solar::]Inspect, $
...
;
; EXAMPLE:
;       Inspect the contents of a LBL_Solar object, x:
;
