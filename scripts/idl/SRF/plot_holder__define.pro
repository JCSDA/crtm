...
PRO plot_holder__define
  ...
  void = { plot_holder,                     $ 
           ...
           f_fm            : PTR_NEW(),     $ ;   frequencies based on first moment IF to MF translation
           f_hm            : PTR_NEW(),     $ ;   frequencies based on half max average IF to MF translation
           f_doc           : PTR_NEW(),     $ ;   frequencies based on documented IF to MF translation
           ...
           f0_hm           : PTR_NEW(),     $ ;   Central Frequencies as average of fwhm points
           f0_fm           : PTR_NEW(),     $ ;   Central Frequencies as first moment
