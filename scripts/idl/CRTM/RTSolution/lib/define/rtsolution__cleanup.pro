...
;
; PURPOSE:
;       The RTSolution::Cleanup procedure method performs cleanup
;       on an RTSolution object when it is destroyed.
;
...
;         or
;
;       Obj->[RTSolution::]Cleanup, Debug=Debug  (In a lifecycle method only)
