;+
; Procedure to set the RTSolution_Viewer Info state

PRO RTSolution_Viewer_SetState, $
  ID  , $          ; Input
  Info, $          ; Input
...
;-
  ...
  ; Debug output
  IF ( (*InfoPtr).Debug EQ 1 ) THEN PRINT, 'RTSolution_Viewer_SetState'

END ; PRO RTSolution_Viewer_SetState
