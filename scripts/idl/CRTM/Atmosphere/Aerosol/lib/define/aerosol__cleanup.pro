...
;
; PURPOSE:
;       The Aerosol::Cleanup procedure method performs cleanup
;       on a Aerosol object when it is destroyed.
;
...
;         or
;
;       Obj->[Aerosol::]Cleanup, Debug=Debug  (In a lifecycle method only)
;
...
PRO Aerosol::Cleanup, Debug=Debug  ; Input keyword
