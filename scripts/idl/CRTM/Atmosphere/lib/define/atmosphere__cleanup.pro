...
;
; PURPOSE:
;       The Atmosphere::Cleanup procedure method performs cleanup
;       on an Atmosphere object when it is destroyed.
;
...
;         or
;
;       Obj->[Atmosphere::]Cleanup, Debug=Debug  (In a lifecycle method only)
...
PRO Atmosphere::Cleanup, Debug=Debug  ; Input keyword
