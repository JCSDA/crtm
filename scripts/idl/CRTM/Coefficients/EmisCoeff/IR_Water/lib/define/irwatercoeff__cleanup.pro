;+
; NAME:
;       IRwaterCoeff::Cleanup
;
; PURPOSE:
;       The IRwaterCoeff::Cleanup procedure method performs cleanup
;       on a IRwaterCoeff object when it is destroyed.
;
...
;         or
;
;       Obj->[IRwaterCoeff::]Cleanup, Debug=Debug  (In a lifecycle method only)
;
...
PRO IRwaterCoeff::Cleanup, Debug=Debug  ; Input keyword
