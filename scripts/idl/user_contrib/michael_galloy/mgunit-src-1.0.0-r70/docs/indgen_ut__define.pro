...
;-
function indgen_ut::test_fail_example
  compile_opt strictarr
...
;-
function indgen_ut::test_baderror
  compile_opt strictarr
  @error_is_fail
  
  a = indgen('another_string')
...
;-
pro indgen_ut__define
  compile_opt strictarr
  
  define = { indgen_ut, inherits MGutTestCase }
end
