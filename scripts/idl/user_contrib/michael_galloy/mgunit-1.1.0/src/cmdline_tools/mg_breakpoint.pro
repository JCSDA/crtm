...
;+
; Convenience wrapper for BREAKPOINT that finds files in !path without having
; to use a full path specification.
;-
...
;+
; A helpful wrapper for BREAKPOINT which finds files in the !path and allows
; relative line numbers within routines.
; 
; :Todo:
...
;       line number with the file (normally) or routine (when ROUTINE keyword
;       is set)
;
; :Keywords:
