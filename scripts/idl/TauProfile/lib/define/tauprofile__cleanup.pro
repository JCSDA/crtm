...
;
; PURPOSE:
;       The TauProfile::Cleanup procedure method performs cleanup
;       on a TauProfile object when it is destroyed.
;
...
;         or
;
;       Obj->[TauProfile::]Cleanup, Debug=Debug  (In a lifecycle method only)
...
PRO TauProfile::Cleanup, Debug=Debug  ; Input keyword
