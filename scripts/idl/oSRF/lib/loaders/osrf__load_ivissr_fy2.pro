;
; NAME:
;       Read_ivissr_fy2_Raw_SRF
;
; PURPOSE:
;       This (private) helper procedure reads individual channel data
;       files and loads the ivissr_fy2 SRF data into arrays and lists.
;
; CALLING SEQUENCE:
;       Read_ivissr_fy2_Raw_SRF, $
;         Filename     , $  ; Input
...
;
; NAME:
;       oSRF::Load_ivissr_fy2
;
; PURPOSE:
;       This procedure loads oSRF objects with ivissr_fy2 SRF data.
;
; CALLING SEQUENCE:
;       obj->[oSRF::]Load_ivissr_fy2, $
;         Sensor_Id        , $ ; Input
;         Channel          , $ ; Input
...
PRO oSRF::Load_ivissr_fy2, $
  ...
  ; Parameters
  HISTORY = "$Id: osrf__load_ivissr_fy2.pro 12692 2012-11-13 20:19:44Z yong.chen@noaa.gov $"
  ...
  ; Read the file
  Read_ivissr_fy2_Raw_SRF, filename, n_points, frequency, response
