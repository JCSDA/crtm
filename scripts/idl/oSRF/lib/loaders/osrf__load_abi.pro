...
;       files and loads the abi SRF data into arrays and lists.
;
; CALLING SEQUENCE:
;       Read_abi_Raw_SRF, $
;         Filename     , $  ; Input
...
;
; PURPOSE:
;       This procedure loads oSRF objects with abi SRF data.
;
; CALLING SEQUENCE:
;       obj->[oSRF::]Load_abi, $
;         Sensor_Id        , $ ; Input
...
PRO oSRF::Load_abi, $
  ...
  ; Read the file
  Read_abi_Raw_SRF, filename, n_points, frequency, response
