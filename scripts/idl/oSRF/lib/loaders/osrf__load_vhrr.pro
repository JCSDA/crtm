...
;       files and loads the vhrr SRF data into arrays and lists.
;
; CALLING SEQUENCE:
;       Read_vhrr_Raw_SRF, $
;         Filename     , $  ; Input
...
;
; PURPOSE:
;       This procedure loads oSRF objects with vhrr SRF data.
;
; CALLING SEQUENCE:
;       obj->[oSRF::]Load_vhrr, $
;         Sensor_Id        , $ ; Input
...
PRO oSRF::Load_vhrr, $
  ...
  ; Read the file
  Read_vhrr_Raw_SRF, filename, n_points, frequency, response
