;
; NAME:
;       Read_iras_fy3b_Raw_SRF
;
; PURPOSE:
;       This (private) helper procedure reads individual channel data
;       files and loads the iras_fy3b SRF data into arrays and lists.
;
; CALLING SEQUENCE:
;       Read_iras_fy3b_Raw_SRF, $
;         Filename     , $  ; Input
...
;
; PURPOSE:
;       This procedure loads oSRF objects with iras_fy3b SRF data.
;
; CALLING SEQUENCE:
;       obj->[oSRF::]Load_iras_fy3b, $
;         Sensor_Id        , $ ; Input
;         Channel          , $ ; Input
...
PRO oSRF::Load_iras_fy3b, $
  ...
  ; Read the file
  Read_iras_fy3b_Raw_SRF, filename, n_points, frequency, response
