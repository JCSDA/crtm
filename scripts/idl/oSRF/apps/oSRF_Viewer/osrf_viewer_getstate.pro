;+
; Procedure to get the OSRF_Viewer Info state

PRO OSRF_Viewer_GetState, ID  , $          ; Input
                          Info, $          ; Output
...
;-
  ...
  ; Debug output
  IF ( Info.Debug EQ 1 ) THEN PRINT, 'OSRF_Viewer_GetState'

END ; OSRF_Viewer_GetState
